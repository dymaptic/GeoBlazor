...
/// <summary>
///     Add this attribute to any property on any subclass of <see cref="MapComponent" />, and if the user forgets to set that property, this will throw a <see cref="MissingRequiredChildElementException" /> or <see cref="MissingRequiredOptionsChildElementException" />. This works for both `[Parameter]` properties as well as Child Components registered with `RegisterChildComponent`
/// </summary>
