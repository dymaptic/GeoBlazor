...
public class AuthoringInfo : MapComponent
{
    ...
    /// </param>
    public AuthoringInfo(ColorRamp? colorRamp = null, double? fadeRatio = null, AuthoringInfoField? field1 = null, AuthoringInfoField? field2 = null, IReadOnlyList<string>? fields = null, string? focus = null, bool? isAutoGenerated = null, LengthUnit? lengthUnit = null, double? maxSliderValue = null, double? minSliderValue = null, double? numClasses = null, double? standardDeviationInterval = null, AuthoringInfoStatistics? statistics = null, IReadOnlyList<AuthoringInfoVisualVariable>? visualVariables = null)
    {
...
#pragma warning restore BL0005
    ...
    public override async Task SetParametersAsync(ParameterView parameters)
    {
        ...
        {
            if (parameterValue is { Name: nameof(Fields), Value: IReadOnlyList<string> fields } && !fields.Equals(Fields))
            {
                Fields = new List<string>(fields);
            }

            if (parameterValue is { Name: nameof(VisualVariables), Value: IReadOnlyList<AuthoringInfoVisualVariable> visualVariables } && !visualVariables.Equals(VisualVariables))
            {
