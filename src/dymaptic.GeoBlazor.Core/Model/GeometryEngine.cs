...
public class GeometryEngine : LogicComponent
{
    ...
    /// </returns>
    public async Task<Polygon[]> Buffer(IEnumerable<Geometry> geometries, IEnumerable<double> distances,
        LinearUnit? unit, bool? unionResults)
    {
    ...
    ///     The resulting buffer.
    /// </returns>
    public async Task<Polygon> Buffer(Geometry geometry, double distance, LinearUnit? unit)
    {
    ...
    ///     The resulting buffers
    /// </returns>
    public async Task<Polygon> GeodesicBuffer(Geometry geometry, double distance, LinearUnit? unit)
    {
    ...
    /// </returns>
    public async Task<Geometry[]> Offset(IEnumerable<Geometry> geometries, double offsetDistance,
        LinearUnit? offsetUnit, JoinType? joinType)
    {
        return await InvokeAsync<Geometry[]>("offset", geometries, offsetDistance,
    ...
    /// </returns>
    public async Task<Geometry[]> Offset(IEnumerable<Geometry> geometries, double offsetDistance,
        LinearUnit? offsetUnit, JoinType? joinType, double? bevelRatio)
    {
        return await InvokeAsync<Geometry[]>("offset", geometries, offsetDistance,
