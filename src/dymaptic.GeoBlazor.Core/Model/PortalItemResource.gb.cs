...
#region Public Methods
    ...
    /// </param>
    /// <param name="options">
    ///     - options.cacheBust: If `true`, the browser will send a request to the server instead of using the browser's local cache. If `false`, the browser's default cache handling will be used.
    /// </param>
