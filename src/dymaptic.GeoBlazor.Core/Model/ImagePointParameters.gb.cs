...
///     Input parameters used by the <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-ImageryLayer.html#measurePointOrCentroid">ImageryLayer.measurePointOrCentroid()</a>
///     or <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-rest-imageService.html#measurePointOrCentroid">imageService.measurePointOrCentroid()</a> methods to perform imagery
