...
#region AddressesToLocationsWithString
    ...
    ///     The cancellation token to use for the asynchronous operation.
    /// </param>
    public async Task<List<AddressCandidate>> AddressesToLocations(List<string> addresses, string? countryCode = null,
        List<string>? categories = null, LocationType? locationType = null,
        SpatialReference? outSpatialReference = null, RequestOptions? requestOptions = null,
        string? addressSearchStringParameterName = null, CancellationToken cancellationToken = default)
    {
        return await AddressesToLocations(ESRIGeoLocationUrl, addresses, countryCode, categories, locationType,
