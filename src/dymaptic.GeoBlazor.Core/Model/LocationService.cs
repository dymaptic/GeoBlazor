...
#region LocationToAddress
    ...
    public Task<AddressCandidate> LocationToAddress(Point location, CancellationToken cancellationToken = default)
    {
        return LocationToAddressImplementation(ESRIGeoLocationUrl, location,
    ...
    public Task<AddressCandidate> LocationToAddress(Point location, LocationType? locationType,
        CancellationToken cancellationToken = default)
    {
        return LocationToAddressImplementation(ESRIGeoLocationUrl, location, locationType,
    ...
    public Task<AddressCandidate> LocationToAddress(string url, Point location,
        CancellationToken cancellationToken = default)
    {
        return LocationToAddressImplementation(url, location, null, null,
            null, cancellationToken);
    }
    ...
    public Task<AddressCandidate> LocationToAddress(string url, Point location, LocationType? locationType,
        CancellationToken cancellationToken = default)
    {
        return LocationToAddressImplementation(url, location, locationType, null,
            null, cancellationToken);
    }
    ...
    public Task<AddressCandidate> LocationToAddress(string url, Point location, LocationType? locationType,
        SpatialReference? outSpatialReference, CancellationToken cancellationToken = default)
    {
        return LocationToAddressImplementation(url, location, locationType, outSpatialReference, null,
            cancellationToken);
    }
    ...
    public Task<AddressCandidate> LocationToAddress(string url, Point location, LocationType? locationType,
        ...
        CancellationToken cancellationToken = default)
    {
        return LocationToAddressImplementation(url, location, locationType, outSpatialReference, requestOptions,
            cancellationToken);
    }
...
#region SuggestLocations
    ...
    public Task<List<SuggestionResult>> SuggestLocations(Point location, string text,
        CancellationToken cancellationToken = default)
    {
        return SuggestLocationsImplementation(ESRIGeoLocationUrl, location, text, null, null,
            cancellationToken);
    }
    ...
    {
        return SuggestLocationsImplementation(ESRIGeoLocationUrl, location, text, categories,
            null, cancellationToken);
    }
    ...
    public Task<List<SuggestionResult>> SuggestLocations(Point location, string text,
        ...
        CancellationToken cancellationToken = default)
    {
        return SuggestLocationsImplementation(ESRIGeoLocationUrl, location, text, categories, requestOptions,
            cancellationToken);
    }
    ...
    /// </param>
    /// <param name="cancellationToken">The cancellation token.</param>
    public Task<List<SuggestionResult>> SuggestLocations(string url, Point location, string text,
        CancellationToken cancellationToken = default)
    {
        return SuggestLocationsImplementation(url, location, text, null, null,
            cancellationToken);
    }
    ...
    public Task<List<SuggestionResult>> SuggestLocations(string url, Point location, string text,
        List<string>? categories, CancellationToken cancellationToken = default)
    {
        return SuggestLocationsImplementation(url, location, text, categories, null, cancellationToken);
    }
    ...
    public Task<List<SuggestionResult>> SuggestLocations(string url, Point location, string text,
        ...
        CancellationToken cancellationToken = default)
    {
        return SuggestLocationsImplementation(url, location, text, categories, requestOptions, cancellationToken);
    }
