...
/// <summary>
///     <a target="_blank" href="https://docs.geoblazor.com/pages/classes/dymaptic.GeoBlazor.Core.Model.CapabilitiesQuery.html">GeoBlazor Docs</a>
...
///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-FeatureLayer.html#Capabilities">ArcGIS Maps SDK for JavaScript</a>
/// </param>
/// <param name="SupportedSpatialAggregationStatistics">
...
///     Indicates if the query operation supports a <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-rest-support-Query.html#cacheHint">cache hint</a>.
///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-FeatureLayer.html#Capabilities">ArcGIS Maps SDK for JavaScript</a>
/// </param>
...
///     Indicates if the layer supports queries for distinct values based on fields specified in the <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-FeatureLayer.html#outFields">outFields</a>.
///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-FeatureLayer.html#Capabilities">ArcGIS Maps SDK for JavaScript</a>
/// </param>
...
///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-FeatureLayer.html#Capabilities">ArcGIS Maps SDK for JavaScript</a>
/// </param>
/// <param name="SupportsMaxRecordCountFactor">
///     Indicates if the layer supports <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-rest-support-Query.html#maxRecordCountFactor">Query.maxRecordCountFactor</a> on the service.
///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-FeatureLayer.html#Capabilities">ArcGIS Maps SDK for JavaScript</a>
/// </param>
...
public partial record CapabilitiesQuery(
    ...
    [property:JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    CapabilitiesQuerySupportedSpatialAggregationStatistics? SupportedSpatialAggregationStatistics = null,
    [property:JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    [property:JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    bool? SupportsMaxRecordCountFactor = null,
    [property:JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
