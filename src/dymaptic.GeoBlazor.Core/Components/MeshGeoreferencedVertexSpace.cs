...
public record MeshGeoreferencedVertexSpace(double[]? Origin) : IMeshVertexSpace, IProtobufSerializable
{
    ...
    internal MeshVertexSpaceSerializationRecord ToSerializationRecord()
    {
