...
public partial class AggregateField : MapComponent
{
    ...
    ///     <see cref = "FeatureReductionCluster"/> visualizations. You should avoid setting or changing this value. If true,
    ...
    /// <summary>
    ///     The name of the
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-FeatureLayer.html#fields">
    ///         layer
    ///         field
    ///     </a>
    ///     to summarize with the given <see cref = "StatisticType"/>.
    /// </summary>
    [Parameter]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    /// <summary>
    ///     Defines the type of statistic used to aggregate data returned from <see cref = "OnStatisticField"/> or
    ///     <see cref = "OnStatisticExpression"/>.
    /// </summary>
    [Parameter]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
