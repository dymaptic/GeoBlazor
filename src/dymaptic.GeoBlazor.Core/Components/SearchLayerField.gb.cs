...
///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-webdoc-applicationProperties-SearchLayerField.html">ArcGIS Maps SDK for JavaScript</a>
/// </summary>
public partial class SearchLayerField : MapComponent
{
    ...
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-webdoc-applicationProperties-SearchLayerField.html#exactMatch">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    /// <param name="name">
...
#region Public Properties / Blazor Parameters
    ...
    /// <summary>
    ///     <a target="_blank" href="https://docs.geoblazor.com/pages/classes/dymaptic.GeoBlazor.Core.Components.SearchLayerField.html#searchlayerfieldexactmatch-property">GeoBlazor Docs</a>
    ///     Whether or not the field is an exact match.
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-webdoc-applicationProperties-SearchLayerField.html#exactMatch">ArcGIS Maps SDK for JavaScript</a>
    /// </summary>
    [ArcGISProperty]
...
#region Property Getters
    ...
    public async Task<bool?> GetExactMatch()
    {
        ...
        bool? result = await JsComponentReference!.InvokeJsMethod<bool?>(
            IsServer, nameof(GeoBlazorSerialization.GET_PROPERTY), nameof(SearchLayerField), View?.QueryResultsMaxSizeLimit,
