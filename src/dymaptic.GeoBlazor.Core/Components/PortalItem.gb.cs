...
#pragma warning restore BL0005
    ...
    public async Task<Portal?> GetPortal()
    {
        ...
        try
        {
            result = await CoreJsModule.InvokeAsync<Portal?>(
