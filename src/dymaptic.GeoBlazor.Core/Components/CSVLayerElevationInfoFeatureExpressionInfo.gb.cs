...
public partial class CSVLayerElevationInfoFeatureExpressionInfo : MapComponent
{
    ...
    public CSVLayerElevationInfoFeatureExpressionInfo()
    {
    }
...
#region Property Getters
    ...
    public async Task<string?> GetExpression()
    {
        ...
        string? result = await JsComponentReference!.InvokeJsMethod<string?>(
            IsServer, nameof(GeoBlazorSerialization.GET_PROPERTY), nameof(CSVLayerElevationInfoFeatureExpressionInfo), View?.QueryResultsMaxSizeLimit,
