...
/// <summary>
///     <a target="_blank" href="https://docs.geoblazor.com/pages/classes/dymaptic.GeoBlazor.Core.Components.UniqueValueInfo.html">GeoBlazor Docs</a>
...
#region Property Getters
    ...
    public async Task<string?> GetLabel()
    {
        ...
        string? result = await JsComponentReference!.InvokeJsMethod<string?>(
            IsServer, GeoBlazorSerialization.GET_PROPERTY, nameof(UniqueValueInfo), View?.QueryResultsMaxSizeLimit,
