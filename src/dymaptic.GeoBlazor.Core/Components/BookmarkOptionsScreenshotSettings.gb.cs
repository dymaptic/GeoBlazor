...
public partial class BookmarkOptionsScreenshotSettings
{
    ...
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-Bookmarks-BookmarksViewModel.html#BookmarkOptions">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    public BookmarkOptionsScreenshotSettings(BookmarkOptionsScreenshotSettingsArea? area = null,
        int? height = null,
...
#region Property Getters
    ...
    public async Task<BookmarkOptionsScreenshotSettingsArea?> GetArea()
    {
        ...
        BookmarkOptionsScreenshotSettingsArea? result =
            await JsComponentReference.InvokeAsync<BookmarkOptionsScreenshotSettingsArea?>("getArea",
...
#pragma warning restore BL0005
    ...
    public async Task<IReadOnlyList<Layer>?> GetLayers()
    {
        ...
        IReadOnlyList<Layer>? result =
            await JsComponentReference.InvokeAsync<IReadOnlyList<Layer>?>("getLayers", CancellationTokenSource.Token);
