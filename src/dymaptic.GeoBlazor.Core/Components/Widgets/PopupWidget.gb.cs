...
#region Public Properties / Blazor Parameters
    ...
    /// <summary>
    ///     <a target="_blank" href="https://docs.geoblazor.com/pages/classes/dymaptic.GeoBlazor.Core.Components.Widgets.PopupWidget.html#popupwidgethtmlelementcontent-property">GeoBlazor Docs</a>
    ///     The content of the popup.
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-Popup.html#content">ArcGIS Maps SDK for JavaScript</a>
    /// </summary>
    [ArcGISProperty]
...
#pragma warning restore BL0005
    ...
    /// <summary>
    ///     Asynchronously retrieve the current value of the HTMLElementContent property.
    /// </summary>
    public async Task<HTMLElement?> GetHTMLElementContent()
    {
        if (CoreJsModule is null)
        {
        ...
        HTMLElement? result = await JsComponentReference!.InvokeJsMethod<HTMLElement?>(
            IsServer, "GetProperty", nameof(PopupWidget, View?.QueryResultsMaxSizeLimit,
            CancellationTokenSource.Token, "content");
        if (result is not null)
        {
#pragma warning disable BL0005
             HTMLElementContent = result;
#pragma warning restore BL0005
             ModifiedParameters[nameof(HTMLElementContent)] = HTMLElementContent;
        }
...
#pragma warning restore BL0005
    ...
    public async Task<Widget?> GetWidgetContent()
    {
        ...
        Widget? result = await JsComponentReference.InvokeJsMethod<Widget?>(
            IsServer, nameof(GetWidgetContent), nameof(PopupWidget), View?.QueryResultsMaxSizeLimit, 
            CancellationTokenSource.Token);
...
#pragma warning restore BL0005
    ...
    /// <summary>
    ///    Asynchronously set the value of the HTMLElementContent property after render.
    /// </summary>
    /// <param name="value">
    ///     The value to set.
    /// </param>
    public async Task SetHTMLElementContent(HTMLElement? value)
    {
#pragma warning disable BL0005
        HTMLElementContent = value;
#pragma warning restore BL0005
        ModifiedParameters[nameof(HTMLElementContent)] = value;
...
#pragma warning restore BL0005
        ...
        await JsComponentReference.InvokeVoidJsMethod(IsServer, 
            nameof(SetWidgetContent), nameof(PopupWidget), 
            CancellationTokenSource.Token, value);
    }
