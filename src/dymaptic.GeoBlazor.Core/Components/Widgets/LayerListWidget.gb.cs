...
#pragma warning restore BL0005
    ...
    public async Task<LayerListCatalogOptions?> GetCatalogOptions()
    {
        ...
        LayerListCatalogOptions? result =
            await JsComponentReference.InvokeAsync<LayerListCatalogOptions?>("getCatalogOptions",
                CancellationTokenSource.Token);
...
#pragma warning restore BL0005
    ...
    public async Task<LayerListKnowledgeGraphOptions?> GetKnowledgeGraphOptions()
    {
        ...
        LayerListKnowledgeGraphOptions? result =
            await JsComponentReference.InvokeAsync<LayerListKnowledgeGraphOptions?>("getKnowledgeGraphOptions",
                CancellationTokenSource.Token);
...
#pragma warning restore BL0005
    ...
    public async Task<LayerListViewModel?> GetViewModel()
    {
        ...
        LayerListViewModel? result =
            await JsComponentReference.InvokeAsync<LayerListViewModel?>("getViewModel", CancellationTokenSource.Token);
