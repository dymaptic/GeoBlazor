...
///     in a <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-views-MapView.html">MapView</a>.
...
public partial class DistanceMeasurement2DWidget : Widget
{
    ...
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-DistanceMeasurement2D.html#icon">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    /// <param name="label">
...
#pragma warning restore BL0005
    ...
    public async Task<IReadOnlyList<SystemOrLengthUnit>?> GetUnitOptions()
    {
        ...
        IReadOnlyList<SystemOrLengthUnit>? result = await JsComponentReference!.InvokeJsMethod<IReadOnlyList<SystemOrLengthUnit>?>(
            IsServer, "GetProperty", nameof(DistanceMeasurement2DWidget, View?.QueryResultsMaxSizeLimit,
