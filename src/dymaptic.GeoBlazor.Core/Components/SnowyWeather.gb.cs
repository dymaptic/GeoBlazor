...
/// <summary>
///     <a target="_blank" href="https://docs.geoblazor.com/pages/classes/dymaptic.GeoBlazor.Core.Components.SnowyWeather.html">GeoBlazor Docs</a>
///     The SnowyWeather class allows you to change the weather conditions in the scene to snowy weather.
///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-views-3d-environment-SnowyWeather.html">ArcGIS Maps SDK for JavaScript</a>
/// </summary>
public partial class SnowyWeather : MapComponent,
    IEnvironmentWeather,
    ISceneViewEnvironmentWeather
{
    ...
    ///     default 0.5
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-views-3d-environment-SnowyWeather.html#cloudCover">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    /// <param name="precipitation">
    ///     Specifies the amount of falling snow.
    ///     default 0.5
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-views-3d-environment-SnowyWeather.html#precipitation">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    /// <param name="snowCover">
    ///     Display surfaces covered with snow.
    ///     default "disabled"
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-views-3d-environment-SnowyWeather.html#snowCover">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    public SnowyWeather(
...
#pragma warning restore BL0005
    ...
    /// </summary>
    public async Task<SnowCover?> GetSnowCover()
    {
        if (CoreJsModule is null)
        {
            return SnowCover;
        ...
        // get the property value
        JsNullableEnumWrapper<SnowCover>? result = await CoreJsModule!.InvokeAsync<JsNullableEnumWrapper<SnowCover>?>("getNullableValueTypedProperty",
            CancellationTokenSource.Token, JsComponentReference, "snowCover");
        if (result is { Value: not null })
        {
#pragma warning disable BL0005
             SnowCover = (SnowCover)result.Value.Value!;
#pragma warning restore BL0005
             ModifiedParameters[nameof(SnowCover)] = SnowCover;
        }
...
#pragma warning restore BL0005
    ...
    ///     The value to set.
    /// </param>
    public async Task SetSnowCover(SnowCover? value)
    {
#pragma warning disable BL0005
        SnowCover = value;
#pragma warning restore BL0005
        ModifiedParameters[nameof(SnowCover)] = value;
        ...
        await CoreJsModule.InvokeVoidAsync("setProperty", CancellationTokenSource.Token,
            JsComponentReference, "snowCover", value);
    }
