...
/// <summary>
///     <a target="_blank" href="https://docs.geoblazor.com/pages/classes/dymaptic.GeoBlazor.Core.Components.CapabilitiesAttachment.html">GeoBlazor Docs</a>
...
#region Property Getters
    ...
    public async Task<bool?> GetSupportsCacheHint()
    {
        ...
        bool? result = await JsComponentReference!.InvokeJsMethod<bool?>(
            IsServer, GeoBlazorSerialization.GET_PROPERTY, nameof(CapabilitiesAttachment), View?.QueryResultsMaxSizeLimit,
