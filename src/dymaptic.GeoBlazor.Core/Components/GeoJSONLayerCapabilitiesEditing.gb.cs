...
/// </summary>
public partial class GeoJSONLayerCapabilitiesEditing : MapComponent
{
    ...
    public GeoJSONLayerCapabilitiesEditing()
    {
    }
    ...
    ///     Indicates if the `globalid` values provided by the client are used in <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-GeoJSONLayer.html#applyEdits">applyEdits</a>.
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-GeoJSONLayer.html#capabilities">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
