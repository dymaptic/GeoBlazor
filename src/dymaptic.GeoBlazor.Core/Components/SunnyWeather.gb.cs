...
/// <summary>
///     <a target="_blank" href="https://docs.geoblazor.com/pages/classes/dymaptic.GeoBlazor.Core.Components.SunnyWeather.html">GeoBlazor Docs</a>
///     The SunnyWeather class allows you to change the weather conditions in the scene to sunny weather.
///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-views-3d-environment-SunnyWeather.html">ArcGIS Maps SDK for JavaScript</a>
/// </summary>
public partial class SunnyWeather : MapComponent,
    IEnvironmentWeather,
    ISceneViewEnvironmentWeather
{
    ...
    ///     default 0.5
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-views-3d-environment-SunnyWeather.html#cloudCover">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    public SunnyWeather(
