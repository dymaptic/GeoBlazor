    ...
    ILegendElement
{
    ...
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-Legend-support-ActiveLayerInfo.html#HeatmapRampElement">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    public HeatmapRampElement(IReadOnlyList<HeatmapRampStop>? infos = null,
...
#region Property Getters
    ...
    public async Task<IReadOnlyList<HeatmapRampStop>?> GetInfos()
    {
        ...
        IReadOnlyList<HeatmapRampStop>? result =
            await JsComponentReference.InvokeAsync<IReadOnlyList<HeatmapRampStop>?>("getInfos",
