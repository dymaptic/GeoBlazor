...
/// <summary>
///     <a target="_blank" href="https://docs.geoblazor.com/pages/classes/dymaptic.GeoBlazor.Core.Components.CSVLayerElevationInfo.html">GeoBlazor Docs</a>
...
#region Property Getters
    ...
    public async Task<CSVLayerElevationInfoFeatureExpressionInfo?> GetFeatureExpressionInfo()
    {
        ...
        CSVLayerElevationInfoFeatureExpressionInfo? result = await JsComponentReference.InvokeJsMethod<CSVLayerElevationInfoFeatureExpressionInfo?>(
            IsServer, nameof(GetFeatureExpressionInfo), nameof(CSVLayerElevationInfo), View?.QueryResultsMaxSizeLimit, 
...
#pragma warning restore BL0005
    ...
    public async Task<ElevationInfoMode?> GetMode()
    {
        ...
        ElevationInfoMode? result = await JsComponentReference!.InvokeJsMethod<ElevationInfoMode?>(
            IsServer, nameof(GeoBlazorSerialization.GET_PROPERTY), nameof(CSVLayerElevationInfo), View?.QueryResultsMaxSizeLimit,
...
#pragma warning restore BL0005
    ...
    protected override async ValueTask<bool> UnregisterGeneratedChildComponent(MapComponent child)
    {
        switch (child)
        {
            case CSVLayerElevationInfoFeatureExpressionInfo:
