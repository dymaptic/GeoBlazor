...
public class FeatureFilter : MapComponent
{
    ...
    /// </param>
    public FeatureFilter(double? distance = null, Geometry? geometry = null, IReadOnlyList<long>? objectIds = null, SpatialRelationship? spatialRelationship = null, TimeExtent? timeExtent = null, GeometryEngineLinearUnit? units = null, string? where = null)
    {
