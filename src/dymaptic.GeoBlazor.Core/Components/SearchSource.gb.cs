...
///     for use in the <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-Search.html">Search widget</a>  or <a target="_blank" href="https://developers.arcgis.com/javascript/latest/references/map-components/arcgis-search/">Search component</a>.
...
#pragma warning restore BL0005
    ...
    public async Task<SearchSourceFilter?> GetFilter()
    {
        ...
        SearchSourceFilter? result =
            await JsComponentReference.InvokeAsync<SearchSourceFilter?>("getFilter", CancellationTokenSource.Token);
