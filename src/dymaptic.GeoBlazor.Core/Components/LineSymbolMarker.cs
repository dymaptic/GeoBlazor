...
#pragma warning restore BL0005
    ...
    public async Task<LinePlacement?> GetPlacement()
    {
        ...
        // get the property value
#pragma warning disable BL0005
        Placement = await CoreJsModule!.InvokeAsync<LinePlacement?>("getProperty",
            CancellationTokenSource.Token, JsComponentReference, "placement");
#pragma warning restore BL0005
        return Placement;
    }
    ...
    public async Task<LineSymbolMarkerStyle?> GetStyle()
    {
        ...
        // get the property value
#pragma warning disable BL0005
        Style = await CoreJsModule!.InvokeAsync<LineSymbolMarkerStyle?>("getProperty",
...
#pragma warning restore BL0005
        ...
        await CoreJsModule.InvokeVoidAsync("setProperty", CancellationTokenSource.Token,
            JsComponentReference, "placement", value);
    }
