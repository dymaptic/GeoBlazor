...
public partial class Graphic : MapComponent, IEquatable<Graphic>, IProtobufSerializable<GraphicSerializationRecord>
{
    ...
    /// </param>
    [CodeGenerationIgnore]
    public Graphic(Geometry? geometry = null,
        Symbol? symbol = null,
...
#region Public Methods
    ...
    public async Task<string?> GetGlobalId()
    {
        ...
        return await CoreJsModule.InvokeAsync<string?>("getGraphicGlobalId", CancellationTokenSource.Token, Id);
    }
...
#region Public Methods
    ...
    public async Task<PopupTemplate?> GetEffectivePopupTemplate(bool defaultPopupTemplateEnabled)
    {
        ...
        return await CoreJsModule!.InvokeAsync<PopupTemplate?>("getEffectivePopupTemplate",
    ...
    public async Task<ObjectId?> GetObjectId()
    {
        ...
        return await CoreJsModule!.InvokeAsync<ObjectId?>("getObjectIdForGraphic",
            CancellationTokenSource.Token,
            Id, LayerId, ViewId);
    }
