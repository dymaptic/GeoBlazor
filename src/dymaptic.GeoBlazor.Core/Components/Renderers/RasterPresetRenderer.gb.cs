...
public partial class RasterPresetRenderer : MapComponent
{
    ...
    /// </param>
    public RasterPresetRenderer(IReadOnlyList<long>? bandIds = null,
        Method? method = null,
        string? name = null,
...
#pragma warning restore BL0005
    ...
    public async Task<Method?> GetMethod()
    {
        ...
        // get the property value
        JsNullableEnumWrapper<Method>? result = await CoreJsModule!.InvokeAsync<JsNullableEnumWrapper<Method>?>(
