...
#region Property Getters
    ...
    public async Task<string?> GetAlias()
    {
        ...
        string? result = await JsComponentReference!.InvokeJsMethod<string?>(
            IsServer, nameof(GeoBlazorSerialization.GET_PROPERTY), nameof(AggregateField), View?.QueryResultsMaxSizeLimit,
...
#pragma warning restore BL0005
    ...
    public async Task<SupportExpressionInfo?> GetOnStatisticExpression()
    {
        ...
        SupportExpressionInfo? result = await JsComponentReference.InvokeJsMethod<SupportExpressionInfo?>(
            IsServer, nameof(GetOnStatisticExpression), nameof(AggregateField), View?.QueryResultsMaxSizeLimit, 
            CancellationTokenSource.Token);
        
        if (result is not null)
        {
            if (OnStatisticExpression is not null)
            {
                result.Id = OnStatisticExpression.Id;
            }
...
#pragma warning restore BL0005
    ...
    public async Task<AggregateStatisticType?> GetStatisticType()
    {
        ...
        // get the property value
        AggregateStatisticType? result = await JsComponentReference!.InvokeJsMethod<AggregateStatisticType?>(
            IsServer, nameof(GeoBlazorSerialization.GET_PROPERTY), nameof(AggregateField), View?.QueryResultsMaxSizeLimit,
