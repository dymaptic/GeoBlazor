...
public partial class TrackInfo : MapComponent
{
    ...
    /// </param>
    public TrackInfo(bool? enabled = null,
...
#pragma warning restore BL0005
    ...
    public async Task<IReadOnlyList<AggregateField>?> GetFields()
    {
        ...
        IReadOnlyList<AggregateField>? result =
            await JsComponentReference.InvokeAsync<IReadOnlyList<AggregateField>?>("getFields",
...
#pragma warning restore BL0005
    ...
    public async Task<TimeField?> GetTimeField()
    {
        ...
        // get the property value
        JsNullableEnumWrapper<TimeField>? result = await CoreJsModule!.InvokeAsync<JsNullableEnumWrapper<TimeField>?>(
            "getNullableValueTypedProperty",
