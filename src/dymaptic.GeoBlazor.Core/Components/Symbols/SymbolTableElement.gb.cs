...
#region Property Getters
    ...
    public async Task<DotDensityTitle?> GetDotDensityTitle()
    {
        ...
        DotDensityTitle? result = await JsComponentReference.InvokeJsMethod<DotDensityTitle?>(
            IsServer, nameof(GetDotDensityTitle), nameof(SymbolTableElement), View?.QueryResultsMaxSizeLimit, 
            CancellationTokenSource.Token);
        
        if (result is not null)
        {
            if (DotDensityTitle is not null)
            {
                result.Id = DotDensityTitle.Id;
            }
...
#pragma warning restore BL0005
    ...
    public async Task<IReadOnlyList<ISymbolTableElementType>?> GetInfos()
    {
        ...
        IReadOnlyList<ISymbolTableElementType>? result = await JsComponentReference!.InvokeJsMethod<IReadOnlyList<ISymbolTableElementType>?>(
            IsServer, "GetProperty", nameof(SymbolTableElement, View?.QueryResultsMaxSizeLimit,
