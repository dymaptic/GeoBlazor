...
/// <summary>
///     <a target="_blank" href="https://docs.geoblazor.com/pages/classes/dymaptic.GeoBlazor.Core.Components.GraphicsLayerElevationInfoFeatureExpressionInfo.html">GeoBlazor Docs</a>
...
#region Public Properties / Blazor Parameters
    ...
    /// <summary>
    ///     <a target="_blank" href="https://docs.geoblazor.com/pages/classes/dymaptic.GeoBlazor.Core.Components.GraphicsLayerElevationInfoFeatureExpressionInfo.html#graphicslayerelevationinfofeatureexpressioninfoexpression-property">GeoBlazor Docs</a>
    ///     An <a target="_blank" href="https://developers.arcgis.com/javascript/latest/arcade/">Arcade</a> expression following the specification defined by the <a target="_blank" href="https://developers.arcgis.com/javascript/latest/arcade/#z-values">Arcade Feature Z Profile</a>.
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-GraphicsLayer.html#elevationInfo">ArcGIS Maps SDK for JavaScript</a>
    /// </summary>
    [ArcGISProperty]
    ...
    /// <summary>
    ///     <a target="_blank" href="https://docs.geoblazor.com/pages/classes/dymaptic.GeoBlazor.Core.Components.GraphicsLayerElevationInfoFeatureExpressionInfo.html#graphicslayerelevationinfofeatureexpressioninfotitle-property">GeoBlazor Docs</a>
    ///     Title of the expression.
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-GraphicsLayer.html#elevationInfo">ArcGIS Maps SDK for JavaScript</a>
    /// </summary>
    [ArcGISProperty]
...
#region Property Getters
    ...
    public async Task<string?> GetExpression()
    {
        ...
        string? result = await JsComponentReference!.InvokeJsMethod<string?>(
            IsServer, nameof(GeoBlazorSerialization.GET_PROPERTY), nameof(GraphicsLayerElevationInfoFeatureExpressionInfo), View?.QueryResultsMaxSizeLimit,
