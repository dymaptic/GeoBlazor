...
/// <summary>
///     <a target="_blank" href="https://docs.geoblazor.com/pages/classes/dymaptic.GeoBlazor.Core.Components.WFSLayerElevationInfoFeatureExpressionInfo.html">GeoBlazor Docs</a>
...
/// </summary>
public partial class WFSLayerElevationInfoFeatureExpressionInfo : MapComponent
{
    ...
    public WFSLayerElevationInfoFeatureExpressionInfo()
    {
    }
...
#region Property Getters
    ...
    public async Task<string?> GetExpression()
    {
        ...
        string? result = await JsComponentReference!.InvokeJsMethod<string?>(
            IsServer, GeoBlazorSerialization.GET_PROPERTY, nameof(WFSLayerElevationInfoFeatureExpressionInfo), View?.QueryResultsMaxSizeLimit,
