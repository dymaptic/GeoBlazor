    ...
    IScaleRangeLayer
{
    ...
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-WCSLayer.html#multidimensionalDefinition">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    /// <param name="renderer">
    ...
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-WCSLayer.html#bandIds">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    /// <param name="blendMode">
    ///     Blend modes are used to blend layers together to create an interesting effect in a layer, or even to produce what seems like a new layer.
    ///     default "normal"
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-WCSLayer.html#blendMode">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    /// <param name="copyright">
    ///     The copyright text as defined by the service.
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-WCSLayer.html#copyright">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    ...
    ///     default true
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-WCSLayer.html#legendEnabled">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    /// <param name="listMode">
    ...
    ///     default 0
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-WCSLayer.html#maxScale">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    /// <param name="minScale">
    ///     The minimum scale (most zoomed out) at which the layer is visible in the view.
    ///     default 0
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-WCSLayer.html#minScale">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    ...
    ///     default true
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-WCSLayer.html#persistenceEnabled">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    ...
    ///     default true
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-WCSLayer.html#useViewTime">ArcGIS Maps SDK for JavaScript</a>
    /// </param>
    /// <param name="version">
...
#region Public Properties / Blazor Parameters
    ...
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-WCSLayer.html#serviceRasterInfo">ArcGIS Maps SDK for JavaScript</a>
    /// </summary>
    [ArcGISProperty]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonInclude]
    ...
    ///     <a target="_blank" href="https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-WCSLayer.html#spatialReference">ArcGIS Maps SDK for JavaScript</a>
    /// </summary>
    [ArcGISProperty]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonInclude]
...
#region Property Getters
    ...
    public async Task<IReadOnlyList<long>?> GetBandIds()
    {
        ...
        IReadOnlyList<long>? result = await JsComponentReference!.InvokeJsMethod<IReadOnlyList<long>?>(
            IsServer, nameof(GeoBlazorSerialization.GET_PROPERTY), nameof(WCSLayer), View?.QueryResultsMaxSizeLimit,
...
#pragma warning restore BL0005
    ...
    public async Task<CoverageInfo?> GetCoverageInfo()
    {
        ...
        CoverageInfo? result = await JsComponentReference.InvokeJsMethod<CoverageInfo?>(
            IsServer, nameof(GetCoverageInfo), nameof(WCSLayer), View?.QueryResultsMaxSizeLimit,
...
#pragma warning restore BL0005
    ...
    public async Task<Effect?> GetEffect()
    {
        ...
        Effect? result = await JsComponentReference.InvokeJsMethod<Effect?>(
            IsServer, nameof(GetEffect), nameof(WCSLayer), View?.QueryResultsMaxSizeLimit,
            CancellationTokenSource.Token);
...
#pragma warning restore BL0005
    ...
    public async Task<IReadOnlyList<DimensionalDefinition>?> GetMultidimensionalDefinition()
    {
        ...
        IReadOnlyList<DimensionalDefinition>? result = await JsComponentReference.InvokeJsMethod<IReadOnlyList<DimensionalDefinition>?>(
            IsServer, nameof(GetMultidimensionalDefinition), nameof(WCSLayer), View?.QueryResultsMaxSizeLimit,
            CancellationTokenSource.Token);
...
#pragma warning restore BL0005
    ...
    public async Task<MultidimensionalSubset?> GetMultidimensionalSubset()
    {
        ...
        MultidimensionalSubset? result = await JsComponentReference.InvokeJsMethod<MultidimensionalSubset?>(
            IsServer, nameof(GetMultidimensionalSubset), nameof(WCSLayer), View?.QueryResultsMaxSizeLimit,
            CancellationTokenSource.Token);
...
#pragma warning restore BL0005
    ...
    public async Task<PopupTemplate?> GetPopupTemplate()
    {
        ...
        PopupTemplate? result = await JsComponentReference.InvokeJsMethod<PopupTemplate?>(
            IsServer, nameof(GetPopupTemplate), nameof(WCSLayer), View?.QueryResultsMaxSizeLimit,
            CancellationTokenSource.Token);
...
#pragma warning restore BL0005
    ...
    public async Task<PortalItem?> GetPortalItem()
    {
        ...
        PortalItem? result = await JsComponentReference.InvokeJsMethod<PortalItem?>(
            IsServer, nameof(GetPortalItem), nameof(WCSLayer), View?.QueryResultsMaxSizeLimit,
            CancellationTokenSource.Token);
...
#pragma warning restore BL0005
    ...
    public async Task<IReadOnlyList<Field>?> GetRasterFields()
    {
        ...
        IReadOnlyList<Field>? result = await JsComponentReference.InvokeJsMethod<IReadOnlyList<Field>?>(
            IsServer, nameof(GetRasterFields), nameof(WCSLayer), View?.QueryResultsMaxSizeLimit,
            CancellationTokenSource.Token);
...
#pragma warning restore BL0005
    ...
    public async Task<RasterInfo?> GetServiceRasterInfo()
    {
        ...
        RasterInfo? result = await JsComponentReference.InvokeJsMethod<RasterInfo?>(
            IsServer, nameof(GetServiceRasterInfo), nameof(WCSLayer), View?.QueryResultsMaxSizeLimit,
            CancellationTokenSource.Token);
...
#pragma warning restore BL0005
    ...
    public async Task<SpatialReference?> GetSpatialReference()
    {
        ...
        SpatialReference? result = await JsComponentReference.InvokeJsMethod<SpatialReference?>(
            IsServer, nameof(GetSpatialReference), nameof(WCSLayer), View?.QueryResultsMaxSizeLimit,
            CancellationTokenSource.Token);
...
#pragma warning restore BL0005
    ...
    public async Task<TimeExtent?> GetTimeExtent()
    {
        ...
        TimeExtent? result = await JsComponentReference.InvokeJsMethod<TimeExtent?>(
            IsServer, nameof(GetTimeExtent), nameof(WCSLayer), View?.QueryResultsMaxSizeLimit,
            CancellationTokenSource.Token);
...
#pragma warning restore BL0005
    ...
    public async Task<TimeInfo?> GetTimeInfo()
    {
        ...
        TimeInfo? result = await JsComponentReference.InvokeJsMethod<TimeInfo?>(
            IsServer, nameof(GetTimeInfo), nameof(WCSLayer), View?.QueryResultsMaxSizeLimit,
            CancellationTokenSource.Token);
...
#pragma warning restore BL0005
    ...
    public async Task<TimeInterval?> GetTimeOffset()
    {
        ...
        TimeInterval? result = await JsComponentReference.InvokeJsMethod<TimeInterval?>(
            IsServer, nameof(GetTimeOffset), nameof(WCSLayer), View?.QueryResultsMaxSizeLimit,
            CancellationTokenSource.Token);
