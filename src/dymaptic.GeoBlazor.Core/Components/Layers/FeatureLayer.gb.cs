...
#region Public Methods
    ...
    public async Task<Field?> GetField(string fieldName)
    {
        ...
        return await JsComponentReference!.InvokeJsMethod<Field?>(
            IsServer, nameof(GetField), nameof(FeatureLayer), View?.QueryResultsMaxSizeLimit, 
            CancellationTokenSource.Token,
            fieldName);
    }
        ...
        Graphic? feature)
    {
        ...
        return await JsComponentReference!.InvokeJsMethod<Domain?>(
            IsServer, nameof(GetFieldDomain), nameof(FeatureLayer), View?.QueryResultsMaxSizeLimit, 
            CancellationTokenSource.Token,
            fieldName,
            new { feature  });
    }
