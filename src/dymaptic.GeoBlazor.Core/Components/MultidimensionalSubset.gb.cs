...
public partial class MultidimensionalSubset
{
    ...
    /// </param>
    public MultidimensionalSubset(Geometry? areaOfInterest = null,
...
#pragma warning restore BL0005
    ...
    public async Task<IReadOnlyList<SubsetDimension>?> GetDimensions()
    {
        ...
        IReadOnlyList<SubsetDimension>? result =
            await JsComponentReference!.InvokeAsync<IReadOnlyList<SubsetDimension>?>("getProperty",
...
#pragma warning restore BL0005
    ...
    public async Task<IReadOnlyList<DimensionalDefinition>?> GetSubsetDefinitions()
    {
        ...
        IReadOnlyList<DimensionalDefinition>? result =
            await JsComponentReference.InvokeAsync<IReadOnlyList<DimensionalDefinition>?>("getSubsetDefinitions",
