    ...
    IEquatable<ObservableDictionary<TKey, TValue>> where TKey : notnull
{
    ...
    public new void Add(TKey key, TValue value)
    {
        ...
        CollectionChanged?.Invoke(this,
            new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Add, value, key));
    }
    ...
    public new void Remove(TKey key)
    {
        ...
        CollectionChanged?.Invoke(this,
            new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Remove, value, key));
    }
