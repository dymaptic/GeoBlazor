...
export async function buildDotNetResultAreaPropertiesExtendGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.areaUnit)) {
        dotNetResultAreaPropertiesExtend.areaUnit = removeCircularReferences(jsObject.areaUnit);
    }
    ...
    if (hasValue(jsObject.type)) {
        dotNetResultAreaPropertiesExtend.type = removeCircularReferences(jsObject.type);
    }
    
    if (hasValue(jsObject.unit)) {
        dotNetResultAreaPropertiesExtend.unit = removeCircularReferences(jsObject.unit);
    }
