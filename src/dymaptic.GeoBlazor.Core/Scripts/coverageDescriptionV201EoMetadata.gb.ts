...
export async function buildDotNetCoverageDescriptionV201EoMetadataGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.observation)) {
        ...
        dotNetCoverageDescriptionV201EoMetadata.observation = await buildDotNetCoverageDescriptionV201EoMetadataObservation(jsObject.observation, viewId);
    }
