    ...
    switch (jsObject.type) {
        ...
        let dotNetActionBaseProperties: any = {};
            if (hasValue(jsObject.id)) {
                dotNetActionBaseProperties.actionBaseId = removeCircularReferences(jsObject.id);
            }
    
            if (hasValue(jsObject.active)) {
                dotNetActionBaseProperties.active = removeCircularReferences(jsObject.active);
            }
    
            if (hasValue(jsObject.className)) {
                dotNetActionBaseProperties.className = removeCircularReferences(jsObject.className);
            }
    
            if (hasValue(jsObject.disabled)) {
                dotNetActionBaseProperties.disabled = removeCircularReferences(jsObject.disabled);
            }
    
            if (hasValue(jsObject.icon)) {
                dotNetActionBaseProperties.icon = removeCircularReferences(jsObject.icon);
            }
    
            if (hasValue(jsObject.title)) {
                dotNetActionBaseProperties.title = removeCircularReferences(jsObject.title);
            }
    
            if (hasValue(jsObject.type)) {
                dotNetActionBaseProperties.type = removeCircularReferences(jsObject.type);
            }
    
            if (hasValue(jsObject.visible)) {
                dotNetActionBaseProperties.visible = removeCircularReferences(jsObject.visible);
            }
