...
export async function buildJsSliderViewModelGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.inputFormatFunction)) {
        jsSliderViewModel.inputFormatFunction = dotNetObject.inputFormatFunction;
    }
    if (hasValue(dotNetObject.inputParseFunction)) {
        jsSliderViewModel.inputParseFunction = dotNetObject.inputParseFunction;
    }
    if (hasValue(dotNetObject.labelFormatFunction)) {
        jsSliderViewModel.labelFormatFunction = dotNetObject.labelFormatFunction;
    }
