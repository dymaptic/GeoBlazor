...
export async function buildJsBasemapLayerListViewModelGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.baseListItemCreatedFunction)) {
        jsBasemapLayerListViewModel.baseListItemCreatedFunction = dotNetObject.baseListItemCreatedFunction;
    }
    ...
    if (hasValue(dotNetObject.referenceListItemCreatedFunction)) {
        jsBasemapLayerListViewModel.referenceListItemCreatedFunction = dotNetObject.referenceListItemCreatedFunction;
    }
