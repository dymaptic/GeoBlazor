...
export async function buildJsSummaryStatisticsForAgeSummaryStatisticsForAgeParamsOutStatisticTypes(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    let { buildJsSummaryStatisticsForAgeSummaryStatisticsForAgeParamsOutStatisticTypesGenerated } = await import('./summaryStatisticsForAgeSummaryStatisticsForAgeParamsOutStatisticTypes.gb');
