...
export async function buildDotNetPCTrueColorRendererResultGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.renderer)) {
        ...
        dotNetPCTrueColorRendererResult.renderer = await buildDotNetPointCloudRGBRenderer(jsObject.renderer);
    }
