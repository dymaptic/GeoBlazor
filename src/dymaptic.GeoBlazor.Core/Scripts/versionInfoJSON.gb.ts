...
export async function buildDotNetVersionInfoJSONGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.versionIdentifier)) {
        ...
        dotNetVersionInfoJSON.versionIdentifier = await buildDotNetVersionInfoJSONVersionIdentifier(jsObject.versionIdentifier);
    }
