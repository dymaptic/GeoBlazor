...
export async function buildDotNetBasemapToggleViewModel(jsObject: any, viewId: string | null): Promise<any> {
    let {buildDotNetBasemapToggleViewModelGenerated} = await import('./basemapToggleViewModel.gb');
    return await buildDotNetBasemapToggleViewModelGenerated(jsObject, viewId);
}
