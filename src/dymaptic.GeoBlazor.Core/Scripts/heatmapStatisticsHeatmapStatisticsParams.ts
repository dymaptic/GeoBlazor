...
export async function buildDotNetHeatmapStatisticsHeatmapStatisticsParams(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    return await buildDotNetHeatmapStatisticsHeatmapStatisticsParamsGenerated(jsObject, layerId, viewId);
}
