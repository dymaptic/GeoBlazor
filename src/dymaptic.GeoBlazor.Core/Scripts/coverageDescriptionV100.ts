...
export async function buildDotNetCoverageDescriptionV100(jsObject: any, viewId: string | null): Promise<any> {
    let { buildDotNetCoverageDescriptionV100Generated } = await import('./coverageDescriptionV100.gb');
    return await buildDotNetCoverageDescriptionV100Generated(jsObject, viewId);
}
