    ...
    switch (jsObject.type) {
        ...
        let dotNetLineSymbolProperties: any = {};
            if (hasValue(jsObject.color)) {
                dotNetLineSymbolProperties.color = removeCircularReferences(jsObject.color);
            }
    
            if (hasValue(jsObject.type)) {
                dotNetLineSymbolProperties.type = removeCircularReferences(jsObject.type);
            }
    
            if (hasValue(jsObject.width)) {
                dotNetLineSymbolProperties.width = removeCircularReferences(jsObject.width);
            }
