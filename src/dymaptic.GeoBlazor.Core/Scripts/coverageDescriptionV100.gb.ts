...
export async function buildDotNetCoverageDescriptionV100Generated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.domainSet)) {
        ...
        dotNetCoverageDescriptionV100.domainSet = await buildDotNetCoverageDescriptionV100DomainSet(jsObject.domainSet, viewId);
    }
