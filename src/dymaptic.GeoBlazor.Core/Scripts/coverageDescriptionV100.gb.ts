...
export async function buildJsCoverageDescriptionV100Generated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    jsObjectRefs[dotNetObject.id] = jsCoverageDescriptionV100;
...
export async function buildDotNetCoverageDescriptionV100Generated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.domainSet)) {
        ...
        dotNetCoverageDescriptionV100.domainSet = await buildDotNetCoverageDescriptionV100DomainSet(jsObject.domainSet, layerId, viewId);
    }
    ...
    if (hasValue(jsObject.rangeSet)) {
        dotNetCoverageDescriptionV100.rangeSet = removeCircularReferences(jsObject.rangeSet);
    }
    
    if (hasValue(jsObject.supportedCRSs)) {
        dotNetCoverageDescriptionV100.supportedCRSs = removeCircularReferences(jsObject.supportedCRSs);
    }
