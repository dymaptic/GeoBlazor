...
export async function buildJsElevationProfileLineViewGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let dnInstantiatedObject = await buildDotNetElevationProfileLineView(jsElevationProfileLineView);
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null
                    ...
                    if (seenObjects.has(value)) {
                        console.warn(`Circular reference in serializing type ElevationProfileLineView detected at path: ${key}, value: ${value.declaredClass}`);
                        return undefined;
                    }
...
export async function buildDotNetElevationProfileLineViewGenerated(jsObject: any): Promise<any> {
