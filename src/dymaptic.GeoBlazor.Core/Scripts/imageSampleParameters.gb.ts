...
export async function buildDotNetImageSampleParametersGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.interpolation)) {
        dotNetImageSampleParameters.interpolation = removeCircularReferences(jsObject.interpolation);
    }
