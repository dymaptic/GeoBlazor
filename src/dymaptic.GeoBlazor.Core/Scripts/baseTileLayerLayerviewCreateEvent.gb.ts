...
export async function buildJsBaseTileLayerLayerviewCreateEventGenerated(dotNetObject: any): Promise<any> {
    ...
    if (hasValue(dotNetObject.view)) {
        jsBaseTileLayerLayerviewCreateEvent.view = dotNetObject.view;
    }
...
export async function buildDotNetBaseTileLayerLayerviewCreateEventGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.view)) {
        dotNetBaseTileLayerLayerviewCreateEvent.view = jsObject.view;
    }
