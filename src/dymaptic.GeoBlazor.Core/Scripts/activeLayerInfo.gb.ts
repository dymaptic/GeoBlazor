...
export async function buildDotNetActiveLayerInfoGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.layer)) {
        dotNetActiveLayerInfo.layer = removeCircularReferences(jsObject.layer);
    }
    
    if (hasValue(jsObject.legendElements)) {
        dotNetActiveLayerInfo.legendElements = removeCircularReferences(jsObject.legendElements);
    }
