...
export async function buildJsLocatorSearchSourceGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.filter)) {
        ...
        properties.filter = await buildJsSearchSourceFilter(dotNetObject.filter, viewId) as any;
    }
    ...
    if (hasValue(dotNetObject.resultSymbol)) {
        ...
        properties.resultSymbol = buildJsSymbol(dotNetObject.resultSymbol, viewId) as any;
    }
...
export async function buildDotNetLocatorSearchSourceGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.popupTemplate)) {
        ...
        dotNetLocatorSearchSource.popupTemplate = await buildDotNetPopupTemplate(jsObject.popupTemplate, viewId);
    }
    ...
    if (hasValue(jsObject.locationType)) {
        dotNetLocatorSearchSource.locationType = removeCircularReferences(jsObject.locationType);
    }
