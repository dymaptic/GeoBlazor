...
export default class WMTSLayerGenerated extends BaseComponent {
    ...
    getCustomLayerParameters(): any {
        ...
        return removeCircularReferences(this.layer.customLayerParameters);
    }
...
export async function buildDotNetWMTSLayerGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.customLayerParameters)) {
        dotNetWMTSLayer.customLayerParameters = removeCircularReferences(jsObject.customLayerParameters);
    }
    ...
    if (hasValue(geoBlazorId)) {
        ...
        if (hasValue(dotNetRef)) {
            try {
                dotNetWMTSLayer.id = await dotNetRef.invokeMethodAsync('GetId');
            } catch (e) {
                console.error('Error invoking GetId for WMTSLayer', e);
            }
        }
    }
