...
export async function buildJsPortalBasemapsSourceGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.filterFunction)) {
        jsPortalBasemapsSource.filterFunction = dotNetObject.filterFunction;
    }
    if (hasValue(dotNetObject.query)) {
        jsPortalBasemapsSource.query = dotNetObject.query;
    }
    if (hasValue(dotNetObject.updateBasemapsCallback)) {
        jsPortalBasemapsSource.updateBasemapsCallback = dotNetObject.updateBasemapsCallback;
    }
