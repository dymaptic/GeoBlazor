...
export async function buildDotNetCoordinateSegmentGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        dotNetCoordinateSegment.id = await dotNetRef.invokeMethodAsync('GetId');
    }
    if (hasValue(dotNetCoordinateSegment.id)) {
        jsObjectRefs[dotNetCoordinateSegment.id] ??= jsObject;
        arcGisObjectRefs[dotNetCoordinateSegment.id] ??= jsObject;
    }
