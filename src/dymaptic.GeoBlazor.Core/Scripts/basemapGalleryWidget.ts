...
export async function buildDotNetBasemapGalleryWidget(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    let {buildDotNetBasemapGalleryWidgetGenerated} = await import('./basemapGalleryWidget.gb');
    return await buildDotNetBasemapGalleryWidgetGenerated(jsObject, layerId, viewId);
}
