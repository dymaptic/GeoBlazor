...
export async function buildJsClassedSizeSliderViewModelGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.inputFormatFunction)) {
        jsClassedSizeSliderViewModel.inputFormatFunction = dotNetObject.sliderLabelFormatter;
    }
    if (hasValue(dotNetObject.inputParseFunction)) {
        jsClassedSizeSliderViewModel.inputParseFunction = dotNetObject.inputParser;
    }
    if (hasValue(dotNetObject.labelFormatFunction)) {
        jsClassedSizeSliderViewModel.labelFormatFunction = dotNetObject.sliderLabelFormatter;
    }
