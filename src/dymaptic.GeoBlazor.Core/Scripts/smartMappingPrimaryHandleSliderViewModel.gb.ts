...
export async function buildJsSmartMappingPrimaryHandleSliderViewModelGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.inputFormatFunction)) {
        jsSmartMappingPrimaryHandleSliderViewModel.inputFormatFunction = dotNetObject.sliderLabelFormatter;
    }
    if (hasValue(dotNetObject.inputParseFunction)) {
        jsSmartMappingPrimaryHandleSliderViewModel.inputParseFunction = dotNetObject.inputParser;
    }
    if (hasValue(dotNetObject.labelFormatFunction)) {
        jsSmartMappingPrimaryHandleSliderViewModel.labelFormatFunction = dotNetObject.sliderLabelFormatter;
    }
