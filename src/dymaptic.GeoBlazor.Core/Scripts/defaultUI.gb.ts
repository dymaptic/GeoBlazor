...
export async function buildDotNetDefaultUIGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.padding)) {
        dotNetDefaultUI.padding = removeCircularReferences(jsObject.padding);
    }
