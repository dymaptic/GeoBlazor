...
export default class FeatureLayerGenerated implements IPropertyWrapper {
    ...
    async updateComponent(dotNetObject: any): Promise<void> {
        ...
        if (hasValue(dotNetObject.elevationInfo)) {
            ...
            this.layer.elevationInfo = await buildJsFeatureLayerBaseElevationInfo(dotNetObject.elevationInfo, this.viewId) as any;
        }
        ...
        if (hasValue(dotNetObject.fields) && dotNetObject.fields.length > 0) {
            ...
            this.layer.fields = dotNetObject.fields.map(i => buildJsField(i, this.viewId)) as any;
        }
        if (hasValue(dotNetObject.floorInfo)) {
            let { buildJsLayerFloorInfo } = await import('./layerFloorInfo');
            this.layer.floorInfo = await buildJsLayerFloorInfo(dotNetObject.floorInfo, this.viewId) as any;
        }
        ...
        if (hasValue(dotNetObject.timeExtent)) {
            ...
            this.layer.timeExtent = await buildJsTimeExtent(dotNetObject.timeExtent, this.viewId) as any;
        }
        if (hasValue(dotNetObject.timeInfo)) {
            let { buildJsTimeInfo } = await import('./timeInfo');
            this.layer.timeInfo = await buildJsTimeInfo(dotNetObject.timeInfo, this.viewId) as any;
        }
        ...
        if (hasValue(dotNetObject.dateFieldsTimeZone)) {
            this.layer.dateFieldsTimeZone = dotNetObject.dateFieldsTimeZone;
        }
        ...
        if (hasValue(dotNetObject.hasZ)) {
            this.layer.hasZ = dotNetObject.hasZ;
        }
        ...
        if (hasValue(dotNetObject.layerIndex)) {
            this.layer.layerId = dotNetObject.layerIndex;
        }
        ...
        if (hasValue(dotNetObject.returnM)) {
            this.layer.returnM = dotNetObject.returnM;
        }
        if (hasValue(dotNetObject.returnZ)) {
            this.layer.returnZ = dotNetObject.returnZ;
        }
    ...
    async addAttachment(feature: any,
        ...
        let jsFeature = buildJsGraphic(feature, this.viewId) as any;
    ...
    async getDynamicDataSource(): Promise<any> {
        ...
        return await buildDotNetDynamicLayer(this.layer.dynamicDataSource, this.viewId);
    }
    ...
    async getEffectiveCapabilities(): Promise<any> {
        ...
        return await buildDotNetCapabilities(this.layer.effectiveCapabilities, this.viewId);
    }
    ...
    async getElevationInfo(): Promise<any> {
        ...
        return await buildDotNetFeatureLayerBaseElevationInfo(this.layer.elevationInfo, this.viewId);
    }
    
    async setElevationInfo(value: any): Promise<void> {
        let { buildJsFeatureLayerBaseElevationInfo } = await import('./featureLayerBaseElevationInfo');
        this.layer.elevationInfo = await  buildJsFeatureLayerBaseElevationInfo(value, this.viewId);
    }
    ...
    async setFields(value: any): Promise<void> {
        ...
        let { buildJsField } = await import('./field');
        this.layer.fields = value.map(i => buildJsField(i, this.viewId)) as any;
    }
    ...
    async getFloorInfo(): Promise<any> {
        ...
        return await buildDotNetLayerFloorInfo(this.layer.floorInfo, this.viewId);
    }
    
    async setFloorInfo(value: any): Promise<void> {
        let { buildJsLayerFloorInfo } = await import('./layerFloorInfo');
        this.layer.floorInfo = await  buildJsLayerFloorInfo(value, this.viewId);
    }
    ...
    async setLabelingInfo(value: any): Promise<void> {
        if (!hasValue(value)) {
            this.layer.labelingInfo.removeAll();
        }
        let { buildJsLabel } = await import('./label');
    ...
    async setSource(value: any): Promise<void> {
        ...
        let { buildJsGraphic } = await import('./graphic');
        this.layer.source = value.map(i => buildJsGraphic(i, this.viewId)) as any;
    }
    ...
    async getTimeExtent(): Promise<any> {
        ...
        return buildDotNetTimeExtent(this.layer.timeExtent, this.viewId);
    }
    
    async setTimeExtent(value: any): Promise<void> {
        let { buildJsTimeExtent } = await import('./timeExtent');
        this.layer.timeExtent = await  buildJsTimeExtent(value, this.viewId);
    }
    ...
    async getTimeInfo(): Promise<any> {
        ...
        return await buildDotNetTimeInfo(this.layer.timeInfo, this.viewId);
    }
    
    async setTimeInfo(value: any): Promise<void> {
        let { buildJsTimeInfo } = await import('./timeInfo');
        this.layer.timeInfo = await  buildJsTimeInfo(value, this.viewId);
    }
    ...
    async getTimeOffset(): Promise<any> {
        ...
        return await buildDotNetTimeInterval(this.layer.timeOffset, this.viewId);
    }
    ...
    async getTypes(): Promise<any> {
        ...
        return await Promise.all(this.layer.types!.map(async i => await buildDotNetFeatureType(i, this.viewId)));
    }
    
    async setTypes(value: any): Promise<void> {
        if (!hasValue(value)) {
            this.layer.types.removeAll();
        }
        let { buildJsFeatureType } = await import('./featureType');
...
export async function buildJsFeatureLayerGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.elevationInfo)) {
        let { buildJsFeatureLayerBaseElevationInfo } = await import('./featureLayerBaseElevationInfo');
        properties.elevationInfo = await buildJsFeatureLayerBaseElevationInfo(dotNetObject.elevationInfo, viewId) as any;
    }
    if (hasValue(dotNetObject.featureEffect)) {
        let { buildJsFeatureEffect } = await import('./featureEffect');
    ...
    if (hasValue(dotNetObject.fields) && dotNetObject.fields.length > 0) {
        let { buildJsField } = await import('./field');
        properties.fields = dotNetObject.fields.map(i => buildJsField(i, viewId)) as any;
    }
    if (hasValue(dotNetObject.floorInfo)) {
        let { buildJsLayerFloorInfo } = await import('./layerFloorInfo');
    ...
    if (hasValue(dotNetObject.timeInfo)) {
        let { buildJsTimeInfo } = await import('./timeInfo');
        properties.timeInfo = await buildJsTimeInfo(dotNetObject.timeInfo, viewId) as any;
    }
    if (hasValue(dotNetObject.timeOffset)) {
        let { buildJsTimeInterval } = await import('./timeInterval');
...
export async function buildDotNetFeatureLayerGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.dynamicDataSource)) {
        let { buildDotNetDynamicLayer } = await import('./dynamicLayer');
        dotNetFeatureLayer.dynamicDataSource = await buildDotNetDynamicLayer(jsObject.dynamicDataSource, viewId);
    }
    
    if (hasValue(jsObject.effect)) {
        let { buildDotNetEffect } = await import('./effect');
        dotNetFeatureLayer.effect = buildDotNetEffect(jsObject.effect, viewId);
    }
    
    if (hasValue(jsObject.effectiveCapabilities)) {
        let { buildDotNetCapabilities } = await import('./capabilities');
        dotNetFeatureLayer.effectiveCapabilities = await buildDotNetCapabilities(jsObject.effectiveCapabilities, viewId);
    }
    
    if (hasValue(jsObject.elevationInfo)) {
        let { buildDotNetFeatureLayerBaseElevationInfo } = await import('./featureLayerBaseElevationInfo');
        dotNetFeatureLayer.elevationInfo = await buildDotNetFeatureLayerBaseElevationInfo(jsObject.elevationInfo, viewId);
    }
    
    if (hasValue(jsObject.featureEffect)) {
        let { buildDotNetFeatureEffect } = await import('./featureEffect');
        dotNetFeatureLayer.featureEffect = await buildDotNetFeatureEffect(jsObject.featureEffect, viewId);
    }
    ...
    if (hasValue(jsObject.fieldsIndex)) {
        let { buildDotNetFieldsIndex } = await import('./fieldsIndex');
        dotNetFeatureLayer.fieldsIndex = await buildDotNetFieldsIndex(jsObject.fieldsIndex, viewId);
    }
    
    if (hasValue(jsObject.floorInfo)) {
        let { buildDotNetLayerFloorInfo } = await import('./layerFloorInfo');
        dotNetFeatureLayer.floorInfo = await buildDotNetLayerFloorInfo(jsObject.floorInfo, viewId);
    }
    
    if (hasValue(jsObject.fullExtent)) {
        let { buildDotNetExtent } = await import('./extent');
        dotNetFeatureLayer.fullExtent = buildDotNetExtent(jsObject.fullExtent, viewId);
    }
    
    if (hasValue(jsObject.labelingInfo)) {
        let { buildDotNetLabel } = await import('./label');
        dotNetFeatureLayer.labelingInfo = await Promise.all(jsObject.labelingInfo.map(async i => await buildDotNetLabel(i, viewId)));
    }
    
    if (hasValue(jsObject.orderBy)) {
        let { buildDotNetOrderByInfo } = await import('./orderByInfo');
        dotNetFeatureLayer.orderBy = await Promise.all(jsObject.orderBy.map(async i => await buildDotNetOrderByInfo(i, viewId)));
    }
    
    if (hasValue(jsObject.popupTemplate)) {
        let { buildDotNetPopupTemplate } = await import('./popupTemplate');
        dotNetFeatureLayer.popupTemplate = await buildDotNetPopupTemplate(jsObject.popupTemplate, viewId);
    }
    
    if (hasValue(jsObject.portalItem)) {
        let { buildDotNetPortalItem } = await import('./portalItem');
        dotNetFeatureLayer.portalItem = await buildDotNetPortalItem(jsObject.portalItem, viewId);
    }
    
    if (hasValue(jsObject.renderer)) {
        let { buildDotNetRenderer } = await import('./renderer');
        dotNetFeatureLayer.renderer = await buildDotNetRenderer(jsObject.renderer, viewId);
    }
    
    if (hasValue(jsObject.spatialReference)) {
        let { buildDotNetSpatialReference } = await import('./spatialReference');
        dotNetFeatureLayer.spatialReference = buildDotNetSpatialReference(jsObject.spatialReference, viewId);
    }
    ...
    if (hasValue(jsObject.timeExtent)) {
        let { buildDotNetTimeExtent } = await import('./timeExtent');
        dotNetFeatureLayer.timeExtent = buildDotNetTimeExtent(jsObject.timeExtent, viewId);
    }
    
    if (hasValue(jsObject.timeInfo)) {
        let { buildDotNetTimeInfo } = await import('./timeInfo');
        dotNetFeatureLayer.timeInfo = await buildDotNetTimeInfo(jsObject.timeInfo, viewId);
    }
    
    if (hasValue(jsObject.timeOffset)) {
        let { buildDotNetTimeInterval } = await import('./timeInterval');
        dotNetFeatureLayer.timeOffset = await buildDotNetTimeInterval(jsObject.timeOffset, viewId);
    }
    
    if (hasValue(jsObject.trackInfo)) {
        let { buildDotNetTrackInfo } = await import('./trackInfo');
        dotNetFeatureLayer.trackInfo = await buildDotNetTrackInfo(jsObject.trackInfo, viewId);
    }
    
    if (hasValue(jsObject.types)) {
        let { buildDotNetFeatureType } = await import('./featureType');
        dotNetFeatureLayer.types = await Promise.all(jsObject.types.map(async i => await buildDotNetFeatureType(i, viewId)));
    }
    
    if (hasValue(jsObject.visibilityTimeExtent)) {
        let { buildDotNetTimeExtent } = await import('./timeExtent');
        dotNetFeatureLayer.visibilityTimeExtent = buildDotNetTimeExtent(jsObject.visibilityTimeExtent, viewId);
    }
    ...
    if (hasValue(jsObject.blendMode)) {
        dotNetFeatureLayer.blendMode = removeCircularReferences(jsObject.blendMode);
    }
    
    if (hasValue(jsObject.capabilities)) {
        dotNetFeatureLayer.capabilities = removeCircularReferences(jsObject.capabilities);
    }
    ...
    if (hasValue(jsObject.customParameters)) {
        dotNetFeatureLayer.customParameters = removeCircularReferences(jsObject.customParameters);
    }
    ...
    if (hasValue(jsObject.displayFilterEnabled)) {
        dotNetFeatureLayer.displayFilterEnabled = jsObject.displayFilterEnabled;
    }
    
    if (hasValue(jsObject.editFieldsInfo)) {
        dotNetFeatureLayer.editFieldsInfo = removeCircularReferences(jsObject.editFieldsInfo);
    }
    ...
    if (hasValue(jsObject.formTemplate)) {
        dotNetFeatureLayer.formTemplate = removeCircularReferences(jsObject.formTemplate);
    }
    ...
    if (hasValue(jsObject.geometryFieldsInfo)) {
        dotNetFeatureLayer.geometryFieldsInfo = removeCircularReferences(jsObject.geometryFieldsInfo);
    }
    ...
    if (hasValue(jsObject.listMode)) {
        dotNetFeatureLayer.listMode = removeCircularReferences(jsObject.listMode);
    }
    ...
    if (hasValue(jsObject.publishingInfo)) {
        dotNetFeatureLayer.publishingInfo = removeCircularReferences(jsObject.publishingInfo);
    }
    ...
    if (hasValue(jsObject.type)) {
        dotNetFeatureLayer.type = removeCircularReferences(jsObject.type);
    }
    ...
    if (hasValue(jsObject.visible)) {
        dotNetFeatureLayer.visible = jsObject.visible;
    }
    ...
    if (hasValue(geoBlazorId)) {
        ...
        dotNetFeatureLayer.id = await dotNetRef.invokeMethodAsync('GetId');
    }
    if (hasValue(dotNetFeatureLayer.id)) {
        jsObjectRefs[dotNetFeatureLayer.id] ??= jsObject;
        arcGisObjectRefs[dotNetFeatureLayer.id] ??= jsObject;
    }
