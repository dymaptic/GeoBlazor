...
import { arcGisObjectRefs, jsObjectRefs, dotNetRefs, hasValue, lookupGeoBlazorId, sanitize, removeCircularReferences, buildJsStreamReference, generateSerializableJson } from './arcGisJsInterop';
...
export default class FeatureLayerGenerated implements IPropertyWrapper {
    ...
    async updateComponent(dotNetObject: any): Promise<void> {
        ...
        if (hasValue(dotNetObject.dynamicDataSource)) {
            this.layer.dynamicDataSource = dotNetObject.dynamicLayer;
        }
        ...
        if (hasValue(dotNetObject.featureReduction)) {
            this.layer.featureReduction = dotNetObject.iFeatureReduction;
        }
        ...
        if (hasValue(dotNetObject.templates) && dotNetObject.templates.length > 0) {
            this.layer.templates = dotNetObject.iFeatureTemplate;
        }
...
export async function buildDotNetFeatureLayerGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.dynamicDataSource)) {
        dotNetFeatureLayer.dynamicDataSource = removeCircularReferences(jsObject.dynamicDataSource);
    }
    ...
    if (hasValue(jsObject.featureReduction)) {
        dotNetFeatureLayer.featureReduction = removeCircularReferences(jsObject.featureReduction);
    }
    ...
    if (hasValue(jsObject.spatialReference)) {
        dotNetFeatureLayer.spatialReference = removeCircularReferences(jsObject.spatialReference);
    }
    ...
    if (hasValue(jsObject.templates)) {
        dotNetFeatureLayer.templates = removeCircularReferences(jsObject.templates);
    }
