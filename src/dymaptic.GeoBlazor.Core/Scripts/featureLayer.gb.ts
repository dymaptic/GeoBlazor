...
export default class FeatureLayerGenerated implements IPropertyWrapper {
    ...
    async addAttachment(feature: any,
        ...
        return await this.layer.addAttachment(feature,
            attachment);
    }
...
let jsEdits = await buildJsFeatureEdits(edits, this.layerId, this.viewId) as any;
    ...
    async deleteAttachments(feature: any,
        ...
        return await this.layer.deleteAttachments(feature,
            attachmentIds);
    }
...
let jsOptions = await buildJsFeatureLayerBaseSaveAsOptions(options) as any;
    ...
    async updateAttachment(feature: any,
        attachmentId: any,
        attachment: any): Promise<any> {
        return await this.layer.updateAttachment(feature,
            attachmentId,
            attachment);
    }
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                if (typeof value === 'object' && value !== null) {
                    if (seenObjects.has(value)) {
                        console.warn(`Circular reference in serializing type FeatureLayer detected at path: ${key}, value: ${value}`);
                        return undefined;
                    }
...
export async function buildDotNetFeatureLayerGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.popupTemplate)) {
        dotNetFeatureLayer.popupTemplate = jsObject.popupTemplate;
    }
