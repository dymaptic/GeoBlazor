...
import { arcGisObjectRefs, jsObjectRefs, dotNetRefs, hasValue, lookupGeoBlazorId, removeCircularReferences, buildJsStreamReference, Pro, generateSerializableJson } from './geoBlazorCore';
    ...
    async addAttachment(feature: any,
        ...
        if (!Pro) {
            ...
            try {
                ...
                jsFeature = buildJsGraphic(feature) as any;
            } catch (e) {
