...
export async function buildJsImageSampleResultGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let dnInstantiatedObject = await buildDotNetImageSampleResult(jsImageSampleResult);
    ...
    try {
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null) {
                    if (seenObjects.has(value)) {
                        console.warn(`Circular reference in serializing type ImageSampleResult detected at path: ${key}, value: ${value.__proto__?.declaredClass}`);
                        return undefined;
                    }
        ...
        console.error('Error invoking OnJsComponentCreated for ImageSampleResult', e);
    }
...
export async function buildDotNetImageSampleResultGenerated(jsObject: any): Promise<any> {
