...
export async function buildDotNetClassBreaksResultGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.classBreakInfos)) {
        ...
        dotNetClassBreaksResult.classBreakInfos = await Promise.all(jsObject.classBreakInfos.map(async i => await buildDotNetClassBreak(i)));
    }
