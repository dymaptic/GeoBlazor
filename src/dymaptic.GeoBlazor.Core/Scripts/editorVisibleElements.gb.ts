...
export async function buildDotNetEditorVisibleElementsGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsEditorVisibleElements } = await import('./editorVisibleElements');
        jsComponentRef = await buildJsEditorVisibleElements(jsObject, layerId, viewId);
    }
    ...
    if (hasValue(jsObject.snappingControlsElements)) {
        ...
        dotNetEditorVisibleElements.snappingControlsElements = await buildDotNetVisibleElementsSnappingControlsElements(jsObject.snappingControlsElements, layerId, viewId);
    }
