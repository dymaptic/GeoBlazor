            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null
                    ...
                    if (seenObjects.has(value)) {
                        console.warn(`Circular reference in serializing type ServiceDefinitionServiceCapabilitiesGeometryCapabilities detected at path: ${key}, value: ${value.declaredClass}`);
                        return undefined;
                    }
