...
export async function buildDotNetImageryLayerGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let dotNetImageryLayer: any = {
        ...
        if (hasValue(jsObject.fullExtent)) {
            ...
            dotNetImageryLayer.fullExtent = await buildDotNetExtent(jsObject.fullExtent);
        }
        ...
        if (hasValue(jsObject.pixelFilter)) {
            let { buildDotNetPixelFilterFunction } = await import('./pixelFilterFunction');
            dotNetImageryLayer.pixelFilter = await buildDotNetPixelFilterFunction(jsObject.pixelFilter);
        }
        ...
        if (hasValue(jsObject.timeExtent)) {
            ...
            dotNetImageryLayer.timeExtent = await buildDotNetTimeExtent(jsObject.timeExtent);
        }
        ...
        if (hasValue(jsObject.visibilityTimeExtent)) {
            let { buildDotNetTimeExtent } = await import('./dotNetBuilder');
            dotNetImageryLayer.visibilityTimeExtent = await buildDotNetTimeExtent(jsObject.visibilityTimeExtent);
        }
