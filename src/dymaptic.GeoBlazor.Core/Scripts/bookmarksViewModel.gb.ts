...
export async function buildDotNetBookmarksViewModelGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetBookmarksViewModel.id)) {
        if (!jsObjectRefs.hasOwnProperty(dotNetBookmarksViewModel.id)) {
            let { default: BookmarksViewModelWrapper } = await import('./bookmarksViewModel');
            let bookmarksViewModelWrapper = new BookmarksViewModelWrapper(jsObject);
            bookmarksViewModelWrapper.geoBlazorId = dotNetBookmarksViewModel.id;
            bookmarksViewModelWrapper.viewId = viewId;
            bookmarksViewModelWrapper.layerId = layerId;
            jsObjectRefs[dotNetBookmarksViewModel.id] = bookmarksViewModelWrapper;
        }
