...
export async function buildDotNetFeatureServiceCapabilitiesData(jsObject: any): Promise<any> {
    let { buildDotNetFeatureServiceCapabilitiesDataGenerated } = await import('./featureServiceCapabilitiesData.gb');
    return await buildDotNetFeatureServiceCapabilitiesDataGenerated(jsObject);
}
