...
import CreateFeaturesWorkflowData = __esri.CreateFeaturesWorkflowData;

export async function buildJsCreateFeaturesWorkflowDataGenerated(dotNetObject: any): Promise<any> {
