    ...
    switch (jsObject.type) {
        ...
        let dotNetMarkerSymbolProperties: any = {};
            if (hasValue(jsObject.angle)) {
                dotNetMarkerSymbolProperties.angle = jsObject.angle;
            }
    
            if (hasValue(jsObject.color)) {
                dotNetMarkerSymbolProperties.color = jsObject.color;
            }
    
            if (hasValue(jsObject.type)) {
                dotNetMarkerSymbolProperties.type = jsObject.type;
            }
    
            if (hasValue(jsObject.xoffset)) {
                dotNetMarkerSymbolProperties.xoffset = jsObject.xoffset;
            }
    
            if (hasValue(jsObject.yoffset)) {
                dotNetMarkerSymbolProperties.yoffset = jsObject.yoffset;
            }
