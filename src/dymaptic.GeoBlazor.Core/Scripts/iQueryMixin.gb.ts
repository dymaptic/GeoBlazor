...
export async function buildJsIQueryMixinGenerated(dotNetObject: any): Promise<any> {
...
export async function buildDotNetIQueryMixinGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.outSpatialReference)) {
        ...
        dotNetIQueryMixin.outSpatialReference = buildDotNetSpatialReference(jsObject.outSpatialReference);
    }
