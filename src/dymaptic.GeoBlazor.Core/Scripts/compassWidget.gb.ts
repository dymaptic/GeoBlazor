...
export default class CompassWidgetGenerated extends BaseComponent {
...
export async function buildDotNetCompassWidgetGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.type)) {
        dotNetCompassWidget.type = removeCircularReferences(jsObject.type);
    }
    ...
    if (hasValue(geoBlazorId)) {
        ...
        if (hasValue(dotNetRef)) {
            try {
                dotNetCompassWidget.id = await dotNetRef.invokeMethodAsync('GetId');
            } catch (e) {
                console.error('Error invoking GetId for CompassWidget', e);
            }
        }
    }
