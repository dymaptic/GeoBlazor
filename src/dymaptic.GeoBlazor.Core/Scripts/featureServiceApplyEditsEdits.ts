...
export async function buildDotNetFeatureServiceApplyEditsEdits(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    let {buildDotNetFeatureServiceApplyEditsEditsGenerated} = await import('./featureServiceApplyEditsEdits.gb');
    return await buildDotNetFeatureServiceApplyEditsEditsGenerated(jsObject, layerId, viewId);
}
