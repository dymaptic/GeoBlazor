...
export async function buildJsAreasAndLengthsParametersGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let { buildDotNetAreasAndLengthsParameters } = await import('./areasAndLengthsParameters');
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null) {
                    if (seenObjects.has(value)) {
                        console.warn(`Circular reference in serializing type AreasAndLengthsParameters detected at path: ${key}, value: ${value.__proto__?.declaredClass}`);
                        return undefined;
                    }
