...
import { arcGisObjectRefs, jsObjectRefs, hasValue, removeCircularReferences, buildJsStreamReference } from './arcGisJsInterop';
...
export async function buildJsElevationSamplerGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    jsElevationSampler.on('changed', async (evt: any) => {
        ...
        await dotNetObject.dotNetComponentReference.invokeMethodAsync('OnJsChanged', streamRef);
    });
...
export async function buildDotNetElevationSamplerGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.demResolution)) {
        dotNetElevationSampler.demResolution = removeCircularReferences(jsObject.demResolution);
    }
    ...
    if (hasValue(jsObject.spatialReference)) {
        dotNetElevationSampler.spatialReference = removeCircularReferences(jsObject.spatialReference);
    }
