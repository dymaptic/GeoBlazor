...
export async function buildDotNetImageParametersGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.imageSpatialReference)) {
        dotNetImageParameters.imageSpatialReference = removeCircularReferences(jsObject.imageSpatialReference);
    }
    ...
    if (hasValue(jsObject.layerOption)) {
        dotNetImageParameters.layerOption = removeCircularReferences(jsObject.layerOption);
    }
