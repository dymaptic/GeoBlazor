...
export async function buildDotNetLegendViewModelLayerInfosGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        dotNetLegendViewModelLayerInfos.id = await dotNetRef.invokeMethodAsync('GetId');
    }
    if (hasValue(dotNetLegendViewModelLayerInfos.id)) {
        jsObjectRefs[dotNetLegendViewModelLayerInfos.id] ??= jsObject;
        arcGisObjectRefs[dotNetLegendViewModelLayerInfos.id] ??= jsObject;
    }
