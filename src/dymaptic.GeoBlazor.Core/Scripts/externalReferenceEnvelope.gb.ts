...
export async function buildDotNetExternalReferenceEnvelopeGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.spatialReference)) {
        ...
        dotNetExternalReferenceEnvelope.spatialReference = await buildDotNetExternalReferenceSpatialReference(jsObject.spatialReference);
    }
