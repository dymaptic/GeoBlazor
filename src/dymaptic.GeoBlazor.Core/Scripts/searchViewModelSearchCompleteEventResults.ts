...
export async function buildDotNetSearchViewModelSearchCompleteEventResults(jsObject: any, viewId: string | null): Promise<any> {
    ...
    return await buildDotNetSearchViewModelSearchCompleteEventResultsGenerated(jsObject, viewId);
}
