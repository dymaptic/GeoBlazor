...
export async function buildDotNetMediaHitGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsMediaHit } = await import('./mediaHit');
        jsComponentRef = await buildJsMediaHit(jsObject, layerId, viewId);
    }
    ...
    if (hasValue(jsObject.sourcePoint)) {
        ...
        dotNetMediaHit.sourcePoint = await buildDotNetSourcePoint(jsObject.sourcePoint, layerId, viewId);
    }
