...
export default class DirectionsLastRouteGenerated implements IPropertyWrapper {
    public component: DirectionsLastRoute;
    public geoBlazorId: string | null = null;
    public viewId: string | null = null;
    public layerId: string | null = null;

    constructor(component: DirectionsLastRoute) {
...
export async function buildJsDirectionsLastRouteGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let { default: DirectionsLastRouteWrapper } = await import('./directionsLastRoute');
    let directionsLastRouteWrapper = new DirectionsLastRouteWrapper(jsDirectionsLastRoute);
    directionsLastRouteWrapper.geoBlazorId = dotNetObject.id;
    directionsLastRouteWrapper.viewId = viewId;
    directionsLastRouteWrapper.layerId = layerId;
    
    // @ts-ignore
    let jsObjectRef = DotNet.createJSObjectReference(directionsLastRouteWrapper);
    jsObjectRefs[dotNetObject.id] = directionsLastRouteWrapper;
    arcGisObjectRefs[dotNetObject.id] = jsDirectionsLastRoute;
    let { buildDotNetDirectionsLastRoute } = await import('./directionsLastRoute');
