...
import { arcGisObjectRefs, jsObjectRefs, dotNetRefs, hasValue, lookupGeoBlazorId, Pro, generateSerializableJson } from './geoBlazorCore';
import {IPropertyWrapper} from './definitions';

import BaseComponent from './baseComponent';

export default class CSVLayerViewGenerated extends BaseComponent implements IPropertyWrapper {
...
export async function buildDotNetCSVLayerViewGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.highlightOptions)) {
        let { buildDotNetHighlightOptions } = await import('./highlightOptions');
        dotNetCSVLayerView.highlightOptions = await buildDotNetHighlightOptions(jsObject.highlightOptions, viewId);
    }
