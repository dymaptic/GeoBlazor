...
export async function buildDotNetRelationshipTypeGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.fieldIndexes)) {
        dotNetRelationshipType.fieldIndexes = removeCircularReferences(jsObject.fieldIndexes);
    }
    ...
    if (hasValue(jsObject.properties)) {
        dotNetRelationshipType.properties = removeCircularReferences(jsObject.properties);
    }
