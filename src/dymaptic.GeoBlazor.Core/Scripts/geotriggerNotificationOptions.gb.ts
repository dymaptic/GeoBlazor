...
export async function buildDotNetGeotriggerNotificationOptionsGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.expressionInfo)) {
        ...
        dotNetGeotriggerNotificationOptions.expressionInfo = await buildDotNetGeotriggersInfoExpressionInfo(jsObject.expressionInfo);
    }
