...
export async function buildDotNetPopupViewModelGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.actions)) {
        dotNetPopupViewModel.actions = removeCircularReferences(jsObject.actions);
    }
    ...
    if (hasValue(jsObject.allActions)) {
        dotNetPopupViewModel.allActions = removeCircularReferences(jsObject.allActions);
    }
    ...
    if (hasValue(jsObject.defaultActions)) {
        dotNetPopupViewModel.defaultActions = removeCircularReferences(jsObject.defaultActions);
    }
    ...
    if (hasValue(jsObject.spatialReference)) {
        dotNetPopupViewModel.spatialReference = removeCircularReferences(jsObject.spatialReference);
    }
