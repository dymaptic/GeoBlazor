...
export async function buildDotNetAggregateFieldGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        dotNetAggregateField.id = await dotNetRef.invokeMethodAsync('GetId');
    }
    if (hasValue(dotNetAggregateField.id)) {
        jsObjectRefs[dotNetAggregateField.id] ??= jsObject;
        arcGisObjectRefs[dotNetAggregateField.id] ??= jsObject;
    }
