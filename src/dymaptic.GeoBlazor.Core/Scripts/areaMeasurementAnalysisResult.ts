...
export async function buildDotNetAreaMeasurementAnalysisResult(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    let { buildDotNetAreaMeasurementAnalysisResultGenerated } = await import('./areaMeasurementAnalysisResult.gb');
    return await buildDotNetAreaMeasurementAnalysisResultGenerated(jsObject, layerId, viewId);
}
