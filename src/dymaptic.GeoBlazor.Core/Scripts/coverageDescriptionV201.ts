...
export async function buildDotNetCoverageDescriptionV201(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    let {buildDotNetCoverageDescriptionV201Generated} = await import('./coverageDescriptionV201.gb');
    return await buildDotNetCoverageDescriptionV201Generated(jsObject, layerId, viewId);
}
