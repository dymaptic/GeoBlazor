...
export async function buildDotNetImageAreaParametersGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        jsComponentRef = await buildJsImageAreaParameters(jsObject, layerId, viewId);
    }
    ...
    if (hasValue(jsObject.mosaicRule)) {
        ...
        dotNetImageAreaParameters.mosaicRule = await buildDotNetMosaicRule(jsObject.mosaicRule, layerId, viewId);
    }
