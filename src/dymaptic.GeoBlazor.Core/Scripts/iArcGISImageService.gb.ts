...
export async function buildDotNetIArcGISImageServiceGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.format)) {
        dotNetIArcGISImageService.format = removeCircularReferences(jsObject.format);
    }
    ...
    if (hasValue(jsObject.noData)) {
        dotNetIArcGISImageService.noData = removeCircularReferences(jsObject.noData);
    }
    
    if (hasValue(jsObject.noDataInterpretation)) {
        dotNetIArcGISImageService.noDataInterpretation = removeCircularReferences(jsObject.noDataInterpretation);
    }
    ...
    if (hasValue(jsObject.pixelType)) {
        dotNetIArcGISImageService.pixelType = removeCircularReferences(jsObject.pixelType);
    }
    ...
    if (hasValue(jsObject.sourceType)) {
        dotNetIArcGISImageService.sourceType = removeCircularReferences(jsObject.sourceType);
    }
    
    if (hasValue(jsObject.spatialReference)) {
        dotNetIArcGISImageService.spatialReference = removeCircularReferences(jsObject.spatialReference);
    }
