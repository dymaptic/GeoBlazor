...
export default class SearchViewModelGenerated extends BaseComponent {
    ...
    getAllPlaceholder(): any {
        ...
        return removeCircularReferences(this.component.allPlaceholder);
    }
    ...
    async getDefaultSymbols(): Promise<any> {
        ...
        return await buildDotNetSearchViewModelDefaultSymbols(this.component.defaultSymbols, this.viewId);
    }
    ...
    getPlaceholder(): any {
        ...
        return removeCircularReferences(this.component.placeholder);
    }
    ...
    getSearchTerm(): any {
        ...
        return removeCircularReferences(this.component.searchTerm);
    }
...
export async function buildDotNetSearchViewModelGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.defaultSymbols)) {
        let { buildDotNetSearchViewModelDefaultSymbols } = await import('./searchViewModelDefaultSymbols');
        dotNetSearchViewModel.defaultSymbols = await buildDotNetSearchViewModelDefaultSymbols(jsObject.defaultSymbols, viewId);
    }
