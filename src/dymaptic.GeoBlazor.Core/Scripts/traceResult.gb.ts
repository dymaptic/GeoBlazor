...
export async function buildJsTraceResultGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.globalFunctionResults) && dotNetObject.globalFunctionResults.length > 0) {
    ...
    if (hasValue(dotNetObject.warnings) && dotNetObject.warnings.length > 0) {
...
export async function buildDotNetTraceResultGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.aggregatedGeometry)) {
        ...
        dotNetTraceResult.aggregatedGeometry = await buildDotNetAggregatedGeometry(jsObject.aggregatedGeometry, layerId, viewId);
    }
    
    if (hasValue(jsObject.elements)) {
        dotNetTraceResult.elements = removeCircularReferences(jsObject.elements);
    }
    
    if (hasValue(jsObject.globalFunctionResults)) {
        dotNetTraceResult.globalFunctionResults = removeCircularReferences(jsObject.globalFunctionResults);
    }
