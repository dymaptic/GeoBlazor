...
export async function buildDotNetElevationProfileLineGroundGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.samples)) {
        dotNetElevationProfileLineGround.samples = removeCircularReferences(jsObject.samples);
    }
    
    if (hasValue(jsObject.statistics)) {
        dotNetElevationProfileLineGround.statistics = removeCircularReferences(jsObject.statistics);
    }
    ...
    if (hasValue(jsObject.type)) {
        dotNetElevationProfileLineGround.type = removeCircularReferences(jsObject.type);
    }
