...
export async function buildDotNetSearchViewModelSelectResultEventGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsSearchViewModelSelectResultEvent } = await import('./searchViewModelSelectResultEvent');
        jsComponentRef = await buildJsSearchViewModelSelectResultEvent(jsObject, layerId, viewId);
    }
