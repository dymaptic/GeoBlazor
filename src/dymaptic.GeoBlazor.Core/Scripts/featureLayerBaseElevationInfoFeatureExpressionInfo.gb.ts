...
export async function buildDotNetFeatureLayerBaseElevationInfoFeatureExpressionInfoGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        dotNetFeatureLayerBaseElevationInfoFeatureExpressionInfo.id = await dotNetRef.invokeMethodAsync('GetId');
    }
    if (hasValue(dotNetFeatureLayerBaseElevationInfoFeatureExpressionInfo.id)) {
        jsObjectRefs[dotNetFeatureLayerBaseElevationInfoFeatureExpressionInfo.id] ??= jsObject;
        arcGisObjectRefs[dotNetFeatureLayerBaseElevationInfoFeatureExpressionInfo.id] ??= jsObject;
    }
