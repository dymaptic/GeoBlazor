...
export async function buildDotNetMapViewHitTestOptionsGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsMapViewHitTestOptions } = await import('./mapViewHitTestOptions');
        jsComponentRef = await buildJsMapViewHitTestOptions(jsObject, layerId, viewId);
    }
