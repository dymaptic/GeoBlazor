...
export async function buildDotNetCoverageDescriptionV110(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    let {buildDotNetCoverageDescriptionV110Generated} = await import('./coverageDescriptionV110.gb');
    return await buildDotNetCoverageDescriptionV110Generated(jsObject, layerId, viewId);
}
