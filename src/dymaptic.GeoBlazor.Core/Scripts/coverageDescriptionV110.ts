...
export async function buildDotNetCoverageDescriptionV110(jsObject: any, viewId: string | null): Promise<any> {
    let { buildDotNetCoverageDescriptionV110Generated } = await import('./coverageDescriptionV110.gb');
    return await buildDotNetCoverageDescriptionV110Generated(jsObject, viewId);
}
