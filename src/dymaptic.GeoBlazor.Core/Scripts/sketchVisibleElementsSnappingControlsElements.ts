...
export async function buildDotNetSketchVisibleElementsSnappingControlsElements(jsObject: any): Promise<any> {
    ...
    return await buildDotNetSketchVisibleElementsSnappingControlsElementsGenerated(jsObject);
}
