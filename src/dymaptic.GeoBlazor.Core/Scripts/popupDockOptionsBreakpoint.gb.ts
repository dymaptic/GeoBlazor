...
export async function buildJsPopupDockOptionsBreakpointGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let dnInstantiatedObject = await buildDotNetPopupDockOptionsBreakpoint(jsPopupDockOptionsBreakpoint);
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null
                    ...
                    if (seenObjects.has(value)) {
                        console.debug(`Circular reference in serializing type PopupDockOptionsBreakpoint detected at path: ${key}, value: ${value.declaredClass}`);
                        return undefined;
                    }
...
export async function buildDotNetPopupDockOptionsBreakpointGenerated(jsObject: any): Promise<any> {
