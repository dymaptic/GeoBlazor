...
export default class LegendWidgetGenerated extends BaseComponent {
    ...
    async updateComponent(dotNetObject: any): Promise<void> {
        ...
        if (hasValue(dotNetObject.style)) {
            ...
            this.widget.style = await buildJsLegendStyle(dotNetObject.style, this.layerId, this.viewId) as any;
        }
    ...
    async getStyle(): Promise<any> {
        ...
        return await buildDotNetLegendStyle(this.widget.style, this.layerId, this.viewId);
    }
    
    async setStyle(value: any): Promise<void> {
        let { buildJsLegendStyle } = await import('./legendStyle');
        this.widget.style = await  buildJsLegendStyle(value, this.layerId, this.viewId);
    }
...
export async function buildJsLegendWidgetGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.style)) {
        let { buildJsLegendStyle } = await import('./legendStyle');
        properties.style = await buildJsLegendStyle(dotNetObject.style, layerId, viewId) as any;
    }
...
export async function buildDotNetLegendWidgetGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.style)) {
        let { buildDotNetLegendStyle } = await import('./legendStyle');
        dotNetLegendWidget.style = await buildDotNetLegendStyle(jsObject.style, layerId, viewId);
    }
