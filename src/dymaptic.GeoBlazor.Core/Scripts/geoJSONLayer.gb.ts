...
export async function buildDotNetGeoJSONLayerGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.capabilities)) {
        let { buildDotNetCapabilities } = await import('./capabilities');
        dotNetGeoJSONLayer.capabilities = await buildDotNetCapabilities(jsObject.capabilities, viewId);
    }
    ...
    if (hasValue(jsObject.effect)) {
        let { buildDotNetEffect } = await import('./effect');
        dotNetGeoJSONLayer.effect = buildDotNetEffect(jsObject.effect, viewId);
    }
    ...
    if (hasValue(jsObject.fullExtent)) {
        let { buildDotNetExtent } = await import('./extent');
        dotNetGeoJSONLayer.fullExtent = buildDotNetExtent(jsObject.fullExtent, viewId);
    }
    ...
    if (hasValue(jsObject.popupTemplate)) {
        let { buildDotNetPopupTemplate } = await import('./popupTemplate');
        dotNetGeoJSONLayer.popupTemplate = await buildDotNetPopupTemplate(jsObject.popupTemplate, viewId);
    }
    ...
    if (hasValue(jsObject.spatialReference)) {
        let { buildDotNetSpatialReference } = await import('./spatialReference');
        dotNetGeoJSONLayer.spatialReference = buildDotNetSpatialReference(jsObject.spatialReference, viewId);
    }
    ...
    if (hasValue(jsObject.timeExtent)) {
        let { buildDotNetTimeExtent } = await import('./timeExtent');
        dotNetGeoJSONLayer.timeExtent = buildDotNetTimeExtent(jsObject.timeExtent, viewId);
    }
    
    if (hasValue(jsObject.timeInfo)) {
        let { buildDotNetTimeInfo } = await import('./timeInfo');
        dotNetGeoJSONLayer.timeInfo = await buildDotNetTimeInfo(jsObject.timeInfo, viewId);
    }
    
    if (hasValue(jsObject.timeOffset)) {
        let { buildDotNetTimeInterval } = await import('./timeInterval');
        dotNetGeoJSONLayer.timeOffset = await buildDotNetTimeInterval(jsObject.timeOffset, viewId);
    }
    ...
    if (hasValue(jsObject.visibilityTimeExtent)) {
        let { buildDotNetTimeExtent } = await import('./timeExtent');
        dotNetGeoJSONLayer.visibilityTimeExtent = buildDotNetTimeExtent(jsObject.visibilityTimeExtent, viewId);
    }
