...
export async function buildDotNetGeoJSONLayerGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.effect)) {
        dotNetGeoJSONLayer.effect = removeCircularReferences(jsObject.effect);
    }
    
    if (hasValue(jsObject.featureReduction)) {
        dotNetGeoJSONLayer.featureReduction = removeCircularReferences(jsObject.featureReduction);
    }
    
    if (hasValue(jsObject.fieldsIndex)) {
        dotNetGeoJSONLayer.fieldsIndex = removeCircularReferences(jsObject.fieldsIndex);
    }
    ...
    if (hasValue(jsObject.renderer)) {
        dotNetGeoJSONLayer.renderer = jsObject.renderer;
    }
    ...
    if (hasValue(jsObject.templates)) {
        dotNetGeoJSONLayer.templates = removeCircularReferences(jsObject.templates);
    }
