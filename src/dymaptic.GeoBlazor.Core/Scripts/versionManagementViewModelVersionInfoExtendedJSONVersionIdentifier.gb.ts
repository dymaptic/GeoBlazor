...
export async function buildJsVersionManagementViewModelVersionInfoExtendedJSONVersionIdentifierGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let dnInstantiatedObject = await buildDotNetVersionManagementViewModelVersionInfoExtendedJSONVersionIdentifier(jsVersionManagementViewModelVersionInfoExtendedJSONVersionIdentifier);
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null
                    ...
                    if (seenObjects.has(value)) {
                        console.warn(`Circular reference in serializing type VersionManagementViewModelVersionInfoExtendedJSONVersionIdentifier detected at path: ${key}, value: ${value.declaredClass}`);
                        return undefined;
                    }
...
export async function buildDotNetVersionManagementViewModelVersionInfoExtendedJSONVersionIdentifierGenerated(jsObject: any): Promise<any> {
