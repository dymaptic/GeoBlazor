...
export async function buildDotNetSearchTableFieldGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        dotNetSearchTableField.id = await dotNetRef.invokeMethodAsync('GetId');
    }
    if (hasValue(dotNetSearchTableField.id)) {
        jsObjectRefs[dotNetSearchTableField.id] ??= jsObject;
        arcGisObjectRefs[dotNetSearchTableField.id] ??= jsObject;
    }
