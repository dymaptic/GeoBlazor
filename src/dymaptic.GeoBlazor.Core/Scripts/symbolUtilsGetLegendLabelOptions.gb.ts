import { buildDotNetSymbolUtilsGetLegendLabelOptions } from './symbolUtilsGetLegendLabelOptions';import symbolUtilsGetLegendLabelOptions = __esri.symbolUtilsGetLegendLabelOptions;
