...
export async function buildDotNetCameraGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.layout)) {
        ...
        dotNetCamera.layout = await buildDotNetCameraLayout(jsObject.layout, viewId);
    }
