...
export async function buildJsVisibleElementsStructuralAttachmentAssociationsSettingsGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let dnInstantiatedObject = await buildDotNetVisibleElementsStructuralAttachmentAssociationsSettings(jsVisibleElementsStructuralAttachmentAssociationsSettings);
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null
                    ...
                    if (seenObjects.has(value)) {
                        console.warn(`Circular reference in serializing type VisibleElementsStructuralAttachmentAssociationsSettings detected at path: ${key}, value: ${value.declaredClass}`);
                        return undefined;
                    }
...
export async function buildDotNetVisibleElementsStructuralAttachmentAssociationsSettingsGenerated(jsObject: any): Promise<any> {
