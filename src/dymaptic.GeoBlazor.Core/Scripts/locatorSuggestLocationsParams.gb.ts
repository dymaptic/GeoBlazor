...
export async function buildDotNetLocatorSuggestLocationsParamsGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        jsComponentRef = await buildJsLocatorSuggestLocationsParams(jsObject, layerId, viewId);
    }
