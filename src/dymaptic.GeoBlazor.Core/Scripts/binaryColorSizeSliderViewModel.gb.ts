...
export async function buildJsBinaryColorSizeSliderViewModelGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.inputFormatFunction)) {
        jsBinaryColorSizeSliderViewModel.inputFormatFunction = dotNetObject.sliderLabelFormatter;
    }
    if (hasValue(dotNetObject.inputParseFunction)) {
        jsBinaryColorSizeSliderViewModel.inputParseFunction = dotNetObject.inputParser;
    }
    if (hasValue(dotNetObject.labelFormatFunction)) {
        jsBinaryColorSizeSliderViewModel.labelFormatFunction = dotNetObject.sliderLabelFormatter;
    }
