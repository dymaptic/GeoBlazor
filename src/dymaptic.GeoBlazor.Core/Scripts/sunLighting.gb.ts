...
export async function buildDotNetSunLightingGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        dotNetSunLighting.id = await dotNetRef.invokeMethodAsync('GetId');
    }
    if (hasValue(dotNetSunLighting.id)) {
        jsObjectRefs[dotNetSunLighting.id] ??= jsObject;
        arcGisObjectRefs[dotNetSunLighting.id] ??= jsObject;
    }
