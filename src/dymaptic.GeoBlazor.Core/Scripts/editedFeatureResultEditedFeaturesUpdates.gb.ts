...
export default class EditedFeatureResultEditedFeaturesUpdatesGenerated implements IPropertyWrapper {
    public component: EditedFeatureResultEditedFeaturesUpdates;
