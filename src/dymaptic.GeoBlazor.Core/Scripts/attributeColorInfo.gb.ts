...
export async function buildJsAttributeColorInfoGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let { buildDotNetAttributeColorInfo } = await import('./attributeColorInfo');
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null
                    ...
                    if (seenObjects.has(value)) {
                        console.debug(`Circular reference in serializing type AttributeColorInfo detected at path: ${key}, value: ${value.declaredClass}`);
                        return undefined;
                    }
