...
import { buildDotNetFeaturesViewModelScreenPoint } from './featuresViewModelScreenPoint';
...
export async function buildDotNetFeaturesViewModelScreenPointGenerated(jsObject: any): Promise<any> {
