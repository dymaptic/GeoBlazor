...
export async function buildDotNetSymbologyPredominanceGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsSymbologyPredominance } = await import('./symbologyPredominance');
        jsComponentRef = await buildJsSymbologyPredominance(jsObject, layerId, viewId);
    }
