...
export async function buildJsCodedValueDomainGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let dnInstantiatedObject = await buildDotNetCodedValueDomain(jsCodedValueDomain, layerId, viewId);
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null
                    ...
                    if (seenObjects.has(value)) {
                        console.debug(`Circular reference in serializing type CodedValueDomain detected at path: ${key}, value: ${value.declaredClass}`);
                        return undefined;
                    }
