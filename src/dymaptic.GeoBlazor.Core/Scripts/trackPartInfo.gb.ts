...
export async function buildDotNetTrackPartInfoGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        dotNetTrackPartInfo.id = await dotNetRef.invokeMethodAsync('GetId');
    }
    if (hasValue(dotNetTrackPartInfo.id)) {
        jsObjectRefs[dotNetTrackPartInfo.id] ??= jsObject;
        arcGisObjectRefs[dotNetTrackPartInfo.id] ??= jsObject;
    }
