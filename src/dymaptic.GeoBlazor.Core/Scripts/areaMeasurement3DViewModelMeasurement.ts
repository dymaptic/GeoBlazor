...
export async function buildDotNetAreaMeasurement3DViewModelMeasurement(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    let { buildDotNetAreaMeasurement3DViewModelMeasurementGenerated } = await import('./areaMeasurement3DViewModelMeasurement.gb');
    return await buildDotNetAreaMeasurement3DViewModelMeasurementGenerated(jsObject, layerId, viewId);
}
