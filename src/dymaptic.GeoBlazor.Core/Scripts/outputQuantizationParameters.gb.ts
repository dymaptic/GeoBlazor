...
export async function buildDotNetOutputQuantizationParametersGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.extent)) {
        ...
        dotNetOutputQuantizationParameters.extent = await buildDotNetOutputQuantizationParametersExtent(jsObject.extent);
    }
    if (hasValue(jsObject.quantizeMode)) {
        dotNetOutputQuantizationParameters.quantizeMode = jsObject.quantizeMode;
    }
