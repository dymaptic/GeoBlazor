...
export async function buildDotNetSceneViewMediaHitGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsSceneViewMediaHit } = await import('./sceneViewMediaHit');
        jsComponentRef = await buildJsSceneViewMediaHit(jsObject, layerId, viewId);
    }
    ...
    if (hasValue(jsObject.sourcePoint)) {
        ...
        dotNetSceneViewMediaHit.sourcePoint = await buildDotNetSourcePoint(jsObject.sourcePoint, layerId, viewId);
    }
