...
export async function buildJsUniqueValuesUniqueValuesParamsGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let { buildDotNetUniqueValuesUniqueValuesParams } = await import('./uniqueValuesUniqueValuesParams');
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null) {
                    if (seenObjects.has(value)) {
                        console.warn(`Circular reference in serializing type UniqueValuesUniqueValuesParams detected at path: ${key}, value: ${value.__proto__?.declaredClass}`);
                        return undefined;
                    }
