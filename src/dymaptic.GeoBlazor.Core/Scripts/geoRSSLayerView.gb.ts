...
export async function buildJsGeoRSSLayerViewGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let jsGeoRSSLayerView = new GeoRSSLayerView(properties);
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                if (typeof value === 'object' && value !== null) {
                    if (seenObjects.has(value)) {
                        console.warn(`Circular reference in serializing type GeoRSSLayerView detected at path: ${key}, value: ${value}`);
                        return undefined;
                    }
