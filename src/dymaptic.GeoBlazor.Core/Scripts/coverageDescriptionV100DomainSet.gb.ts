...
export async function buildDotNetCoverageDescriptionV100DomainSetGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.spatialDomain)) {
        ...
        dotNetCoverageDescriptionV100DomainSet.spatialDomain = await buildDotNetCoverageDescriptionV100DomainSetSpatialDomain(jsObject.spatialDomain, viewId);
    }
