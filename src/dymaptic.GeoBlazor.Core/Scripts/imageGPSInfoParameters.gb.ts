...
export async function buildJsImageGPSInfoParametersGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    jsObjectRefs[dotNetObject.id] = jsImageGPSInfoParameters;
...
export async function buildDotNetImageGPSInfoParametersGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.spatialRelationship)) {
        dotNetImageGPSInfoParameters.spatialRelationship = removeCircularReferences(jsObject.spatialRelationship);
    }
