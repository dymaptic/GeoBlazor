...
export async function buildDotNetVectorTileLayerCurrentStyleInfoGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.layerDefinition)) {
        dotNetVectorTileLayerCurrentStyleInfo.layerDefinition = removeCircularReferences(jsObject.layerDefinition);
    }
    ...
    if (hasValue(jsObject.style)) {
        dotNetVectorTileLayerCurrentStyleInfo.style = removeCircularReferences(jsObject.style);
    }
