...
export async function buildJsRasterSensorInfoGenerated(dotNetObject: any, viewId: string | null): Promise<any> {
...
export async function buildDotNetRasterSensorInfoGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        dotNetRasterSensorInfo.id = await dotNetRef.invokeMethodAsync('GetId');
    }
    if (hasValue(dotNetRasterSensorInfo.id)) {
        jsObjectRefs[dotNetRasterSensorInfo.id] ??= jsObject;
        arcGisObjectRefs[dotNetRasterSensorInfo.id] ??= jsObject;
    }
