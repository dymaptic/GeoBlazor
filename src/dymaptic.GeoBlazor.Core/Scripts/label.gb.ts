...
export default class LabelGenerated extends BaseComponent implements IPropertyWrapper {
    ...
    async updateComponent(dotNetObject: any): Promise<void> {
        ...
        if (hasValue(dotNetObject.labelExpressionInfo)) {
            this.component.labelExpressionInfo = dotNetObject.labelExpressionInfo;
        }
