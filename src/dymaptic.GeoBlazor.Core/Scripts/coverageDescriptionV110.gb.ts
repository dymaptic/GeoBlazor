...
export async function buildJsCoverageDescriptionV110Generated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.supportedCRSs) && dotNetObject.supportedCRSs.length > 0) {
    ...
    jsObjectRefs[dotNetObject.id] = jsCoverageDescriptionV110;
...
export async function buildDotNetCoverageDescriptionV110Generated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.domain)) {
        ...
        dotNetCoverageDescriptionV110.domain = await buildDotNetCoverageDescriptionV110Domain(jsObject.domain, viewId);
    }
    ...
    if (hasValue(jsObject.range)) {
        dotNetCoverageDescriptionV110.range = removeCircularReferences(jsObject.range);
    }
    
    if (hasValue(jsObject.resolution)) {
        dotNetCoverageDescriptionV110.resolution = removeCircularReferences(jsObject.resolution);
    }
