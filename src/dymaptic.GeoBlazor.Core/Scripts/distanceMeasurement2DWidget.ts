...
export async function buildDotNetDistanceMeasurement2DWidget(jsObject: any, viewId: string | null): Promise<any> {
    let {buildDotNetDistanceMeasurement2DWidgetGenerated} = await import('./distanceMeasurement2DWidget.gb');
    return await buildDotNetDistanceMeasurement2DWidgetGenerated(jsObject, viewId);
}
