...
export async function buildDotNetPrintCompleteEventGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.results)) {
        ...
        dotNetPrintCompleteEvent.results = await buildDotNetPrintCompleteEventResults(jsObject.results);
    }
