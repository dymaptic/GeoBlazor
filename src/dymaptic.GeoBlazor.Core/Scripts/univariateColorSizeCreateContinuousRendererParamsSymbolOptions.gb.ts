...
export async function buildJsUnivariateColorSizeCreateContinuousRendererParamsSymbolOptionsGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
