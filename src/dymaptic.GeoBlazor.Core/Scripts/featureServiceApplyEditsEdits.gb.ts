...
export async function buildJsFeatureServiceApplyEditsEditsGenerated(dotNetObject: any): Promise<any> {
    ...
    if (hasValue(dotNetObject.identifierFields)) {
        const {
            ...
            layerId,
            viewId,
            ...sanitizedIdentifierFields
        } = dotNetObject.identifierFields;
