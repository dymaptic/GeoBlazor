...
message CIMScaleDependentSizeVariation {
   double scale = 1;
   int32 size = 2;
}
message CIMSymbolReference {
   double maxDistance = 1;
   double maxScale = 2;
   double minDistance = 3;
   double minScale = 4;
   repeated PrimitiveOverride primitiveOverrides = 5;
   repeated CIMScaleDependentSizeVariation scaleDependentSizeVariation = 6;
   string stylePath = 7;
   Symbol symbol = 8;
   string symbolName = 9;
}
...
message MeshMaterialNormalTexture {
}
message MeshTexture {
...
message PopupTemplate {
   string title = 1;
   repeated string outFields = 2;
   repeated FieldInfo fieldInfos = 3;
   PopupTemplateContent content = 4;
   repeated PopupExpressionInfo expressionInfos = 5;
   bool overwriteActions = 6;
   bool returnGeometry = 7;
   repeated ActionBase actions = 8;
   string id = 9;
   bool hasTitleFunction = 10;
   bool hasContentFunction = 11;
   bool isNull = 1000;
}
...
message PopupTemplateContentSerializationRecord {
   repeated Content contentCollection = 1;
   string elementReferenceId = 2;
   string contentString = 3;
   bool hasContentFunction = 4;
   string widgetId = 5;
}
message PrimitiveOverride {
   string primitiveName = 1;
   string propertyName = 2;
   PrimitiveOverrideValueExpressionInfo valueExpressionInfo = 3;
}
message PrimitiveOverrideValueExpressionInfo {
   string title = 1;
   string expression = 2;
   string name = 3;
   string returnType = 4;
