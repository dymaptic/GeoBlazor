...
export async function buildDotNetAreaMeasurement2DViewModelMeasurementLabel(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    return await buildDotNetAreaMeasurement2DViewModelMeasurementLabelGenerated(jsObject, layerId, viewId);
}
