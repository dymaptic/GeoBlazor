...
export async function buildDotNetVersionInfoExtendedJSONGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsVersionInfoExtendedJSON } = await import('./versionInfoExtendedJSON');
        jsComponentRef = await buildJsVersionInfoExtendedJSON(jsObject, layerId, viewId);
    }
    ...
    if (hasValue(jsObject.versionIdentifier)) {
        ...
        dotNetVersionInfoExtendedJSON.versionIdentifier = await buildDotNetVersionInfoExtendedJSONVersionIdentifier(jsObject.versionIdentifier, layerId, viewId);
    }
