...
export async function buildJsIEditorViewModelGetTemplatesForLayerGenerated(dotNetObject: any, viewId: string | null): Promise<any> {
    ...
    try {
        ...
        let dnInstantiatedObject = await buildDotNetIEditorViewModelGetTemplatesForLayer(jsEditorViewModelGetTemplatesForLayer, viewId);
...
export async function buildDotNetIEditorViewModelGetTemplatesForLayerGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        dotNetIEditorViewModelGetTemplatesForLayer.id = await dotNetRef.invokeMethodAsync('GetId');
    }
    if (hasValue(dotNetIEditorViewModelGetTemplatesForLayer.id)) {
        jsObjectRefs[dotNetIEditorViewModelGetTemplatesForLayer.id] ??= jsObject;
        arcGisObjectRefs[dotNetIEditorViewModelGetTemplatesForLayer.id] ??= jsObject;
    }
