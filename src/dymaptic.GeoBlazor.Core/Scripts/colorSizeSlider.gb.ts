...
export async function buildJsColorSizeSliderGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.inputFormatFunction)) {
        jsColorSizeSlider.inputFormatFunction = dotNetObject.smartMappingSliderBaseLabelFormatter;
    }
    if (hasValue(dotNetObject.inputParseFunction)) {
        jsColorSizeSlider.inputParseFunction = dotNetObject.inputParser;
    }
    if (hasValue(dotNetObject.labelFormatFunction)) {
        jsColorSizeSlider.labelFormatFunction = dotNetObject.smartMappingSliderBaseLabelFormatter;
    }
