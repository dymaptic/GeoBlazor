...
export default class WebMapGenerated extends BaseComponent {
    ...
    async updateComponent(dotNetObject: any): Promise<void> {
        ...
        if (hasValue(dotNetObject.ipsInfo)) {
            this.component.ipsInfo = dotNetObject.iIPSInfo;
        }
    ...
    getPresentation(): any {
        ...
        return this.component.presentation;
    }
    
    setPresentation(value: any): void {
        this.component.presentation = value;
    }
...
export async function buildJsWebMapGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.ipsInfo)) {
        properties.ipsInfo = dotNetObject.ipsInfo;
    }
    if (hasValue(dotNetObject.portalItem)) {
        let { buildJsPortalItem } = await import('./portalItem');
...
export async function buildDotNetWebMapGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.ipsInfo)) {
        dotNetWebMap.ipsInfo = removeCircularReferences(jsObject.ipsInfo);
    }
    ...
    if (hasValue(jsObject.presentation)) {
        dotNetWebMap.presentation = removeCircularReferences(jsObject.presentation);
    }
