...
import { arcGisObjectRefs, jsObjectRefs, dotNetRefs, hasValue, lookupGeoBlazorId, sanitize, removeCircularReferences, generateSerializableJson } from './geoBlazorCore';
...
export default class WebMapGenerated implements IPropertyWrapper {
    ...
    async updateComponent(dotNetObject: any): Promise<void> {
        ...
        if (hasValue(dotNetObject.geotriggersInfo)) {
            this.component.geotriggersInfo = sanitize(dotNetObject.geotriggersInfo);
        }
...
export async function buildJsWebMapGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.geotriggersInfo)) {
        properties.geotriggersInfo = sanitize(dotNetObject.geotriggersInfo);
    }
    if (hasValue(dotNetObject.presentation)) {
