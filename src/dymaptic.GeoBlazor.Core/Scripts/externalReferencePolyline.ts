...
export async function buildDotNetExternalReferencePolyline(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    let { buildDotNetExternalReferencePolylineGenerated } = await import('./externalReferencePolyline.gb');
    return await buildDotNetExternalReferencePolylineGenerated(jsObject, layerId, viewId);
}
