...
export async function buildDotNetLayerSearchSourceGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.filter)) {
        dotNetLayerSearchSource.filter = removeCircularReferences(jsObject.filter);
    }
    
    if (hasValue(jsObject.layer)) {
        dotNetLayerSearchSource.layer = removeCircularReferences(jsObject.layer);
    }
    ...
    if (hasValue(jsObject.resultSymbol)) {
        dotNetLayerSearchSource.resultSymbol = jsObject.resultSymbol;
    }
