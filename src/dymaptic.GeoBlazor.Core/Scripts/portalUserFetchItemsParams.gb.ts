...
export async function buildDotNetPortalUserFetchItemsParamsGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        jsComponentRef = await buildJsPortalUserFetchItemsParams(jsObject, layerId, viewId);
    }
