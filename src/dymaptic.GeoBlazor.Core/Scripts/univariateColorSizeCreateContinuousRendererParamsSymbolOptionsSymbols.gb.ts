import {
    buildDotNetUnivariateColorSizeCreateContinuousRendererParamsSymbolOptionsSymbols
} from './univariateColorSizeCreateContinuousRendererParamsSymbolOptionsSymbols';
import {arcGisObjectRefs, hasValue, jsObjectRefs} from './arcGisJsInterop';

export async function buildJsUnivariateColorSizeCreateContinuousRendererParamsSymbolOptionsSymbolsGenerated(dotNetObject: any): Promise<any> {
