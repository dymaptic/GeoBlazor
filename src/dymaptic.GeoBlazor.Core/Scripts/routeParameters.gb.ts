...
export async function buildJsRouteParametersGenerated(dotNetObject: any): Promise<any> {
    ...
    if (hasValue(dotNetObject.attributeParameterValues)) {
        const {
            ...
            layerId,
            viewId,
            ...sanitizedAttributeParameterValues
        } = dotNetObject.attributeParameterValues;
