            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null) {
                    if (seenObjects.has(value)) {
                        console.warn(`Circular reference in serializing type ZoomWidget detected at path: ${key}, value: ${value.__proto__?.declaredClass}`);
                        return undefined;
                    }
...
export async function buildDotNetZoomWidgetGenerated(jsObject: any): Promise<any> {
    ...
    dotNetZoomWidget.id = lookupGeoBlazorId(jsObject);
