...
export async function buildDotNetFeaturesViewModelFetchFeaturesScreenPoint(jsObject: any, viewId: string | null): Promise<any> {
    ...
    return await buildDotNetFeaturesViewModelFetchFeaturesScreenPointGenerated(jsObject, viewId);
}
