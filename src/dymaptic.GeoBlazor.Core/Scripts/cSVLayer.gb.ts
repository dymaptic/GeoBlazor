...
export async function buildJsCSVLayerGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.hasCreateListener) && dotNetObject.hasCreateListener) {
        jsCSVLayer.on('layerview-create', (evt: any) => {
    ...
    if (hasValue(dotNetObject.hasCreateErrorListener) && dotNetObject.hasCreateErrorListener) {
        jsCSVLayer.on('layerview-create-error', (evt: any) => {
            requestAnimationFrame(async () => {
    ...
    if (hasValue(dotNetObject.hasDestroyListener) && dotNetObject.hasDestroyListener) {
        jsCSVLayer.on('layerview-destroy', (evt: any) => {
            requestAnimationFrame(async () => {
