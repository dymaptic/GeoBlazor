...
export async function buildDotNetBuildingSummaryStatisticsGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsBuildingSummaryStatistics } = await import('./buildingSummaryStatistics');
        jsComponentRef = await buildJsBuildingSummaryStatistics(jsObject, layerId, viewId);
    }
