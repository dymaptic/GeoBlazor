...
export async function buildJsBarcodeScannerInputGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let dnInstantiatedObject = await buildDotNetBarcodeScannerInput(jsBarcodeScannerInput);
    ...
    try {
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null
                    ...
                    if (seenObjects.has(value)) {
                        console.debug(`Circular reference in serializing type BarcodeScannerInput detected at path: ${key}, value: ${value.declaredClass}`);
                        return undefined;
                    }
        ...
        console.error('Error invoking OnJsComponentCreated for BarcodeScannerInput', e);
    }
...
export async function buildDotNetBarcodeScannerInputGenerated(jsObject: any): Promise<any> {
