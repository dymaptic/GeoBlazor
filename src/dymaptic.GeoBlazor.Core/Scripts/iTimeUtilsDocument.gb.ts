...
export function buildJsITimeUtilsDocumentGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): any {
...
export function buildDotNetITimeUtilsDocumentGenerated(jsObject: any, layerId: string | null, viewId: string | null): any {
