...
export default class SublayerGenerated extends BaseComponent {
    ...
    async getDefinitionExpression(): Promise<any> {
        ...
        return this.component.definitionExpression;
    }
    
    setDefinitionExpression(value: any): void {
        this.component.definitionExpression = value;
    }
    ...
    async getObjectIdField(): Promise<any> {
        ...
        return this.component.objectIdField;
    }
    ...
    async getTypeIdField(): Promise<any> {
        ...
        return this.component.typeIdField;
    }
