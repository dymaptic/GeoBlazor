...
export default class SublayerGenerated extends BaseComponent {
    ...
    async getDefinitionExpression(): Promise<any> {
        ...
        return removeCircularReferences(this.component.definitionExpression);
    }
    ...
    async getObjectIdField(): Promise<any> {
        ...
        return removeCircularReferences(this.component.objectIdField);
    }
    ...
    async getTypeIdField(): Promise<any> {
        ...
        return removeCircularReferences(this.component.typeIdField);
    }
