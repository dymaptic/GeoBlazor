            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null) {
                    if (seenObjects.has(value)) {
                        console.warn(`Circular reference in serializing type GeoJSONLayerView detected at path: ${key}, value: ${value.__proto__?.declaredClass}`);
                        return undefined;
                    }
...
export async function buildDotNetGeoJSONLayerViewGenerated(jsObject: any): Promise<any> {
    ...
    dotNetGeoJSONLayerView.id = lookupGeoBlazorId(jsObject);
