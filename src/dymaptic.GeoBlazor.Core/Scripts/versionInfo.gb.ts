...
export async function buildDotNetVersionInfoGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.versionIdentifier)) {
        ...
        dotNetVersionInfo.versionIdentifier = await buildDotNetVersionInfoVersionIdentifier(jsObject.versionIdentifier);
    }
