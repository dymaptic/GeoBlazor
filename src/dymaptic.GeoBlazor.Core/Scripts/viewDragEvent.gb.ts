...
export async function buildDotNetViewDragEventGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.origin)) {
        ...
        dotNetViewDragEvent.origin = await buildDotNetViewDragEventOrigin(jsObject.origin);
    }
