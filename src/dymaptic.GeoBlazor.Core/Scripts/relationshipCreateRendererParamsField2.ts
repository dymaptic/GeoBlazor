...
export async function buildJsRelationshipCreateRendererParamsField2(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    let { buildJsRelationshipCreateRendererParamsField2Generated } = await import('./relationshipCreateRendererParamsField2.gb');
