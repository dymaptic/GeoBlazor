import {
    buildDotNetUnivariateColorSizeCreateContinuousRendererParamsSizeOptions
} from './univariateColorSizeCreateContinuousRendererParamsSizeOptions';
import {arcGisObjectRefs, hasValue, jsObjectRefs} from './arcGisJsInterop';

export async function buildJsUnivariateColorSizeCreateContinuousRendererParamsSizeOptionsGenerated(dotNetObject: any): Promise<any> {
