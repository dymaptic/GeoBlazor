...
export async function buildDotNetGraphQueryStreamingGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.bindGeometryQuantizationParameters)) {
        dotNetGraphQueryStreaming.bindGeometryQuantizationParameters = removeCircularReferences(jsObject.bindGeometryQuantizationParameters);
    }
    
    if (hasValue(jsObject.bindParameters)) {
        dotNetGraphQueryStreaming.bindParameters = removeCircularReferences(jsObject.bindParameters);
    }
    ...
    if (hasValue(jsObject.provenanceBehavior)) {
        dotNetGraphQueryStreaming.provenanceBehavior = removeCircularReferences(jsObject.provenanceBehavior);
    }
