...
export async function buildJsSublayerGetFieldDomainOptionsGenerated(dotNetObject: any): Promise<any> {
    ...
    let dnInstantiatedObject = await buildDotNetSublayerGetFieldDomainOptions(jsSublayerGetFieldDomainOptions);
