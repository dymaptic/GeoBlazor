...
import { arcGisObjectRefs, jsObjectRefs, hasValue, sanitize, removeCircularReferences, generateSerializableJson } from './arcGisJsInterop';
...
export async function buildJsRasterInfoGenerated(dotNetObject: any): Promise<any> {
    ...
    if (hasValue(dotNetObject.keyProperties)) {
        properties.keyProperties = JSON.parse(dotNetObject.keyProperties);
    }
...
export async function buildDotNetRasterInfoGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.keyProperties)) {
        dotNetRasterInfo.keyProperties = generateSerializableJson(jsObject.keyProperties);
    }
    ...
    if (hasValue(jsObject.spatialReference)) {
        dotNetRasterInfo.spatialReference = removeCircularReferences(jsObject.spatialReference);
    }
