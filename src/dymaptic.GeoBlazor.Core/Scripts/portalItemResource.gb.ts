...
export default class PortalItemResourceGenerated extends BaseComponent {
    ...
    getPath(): any {
        ...
        return removeCircularReferences(this.component.path);
    }
...
export async function buildDotNetPortalItemResourceGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetPortalItemResource.id)) {
        if (!jsObjectRefs.hasOwnProperty(dotNetPortalItemResource.id)) {
            ...
            portalItemResourceWrapper.viewId = viewId;
            portalItemResourceWrapper.layerId = layerId;
            jsObjectRefs[dotNetPortalItemResource.id] = portalItemResourceWrapper;
        }
