...
export default class VectorTileLayerGenerated extends BaseComponent {
    ...
    getStyle(): any {
        ...
        return removeCircularReferences(this.layer.style);
    }
...
export async function buildDotNetVectorTileLayerGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.style)) {
        dotNetVectorTileLayer.style = removeCircularReferences(jsObject.style);
    }
