...
export async function buildJsISliceAnalysisExcludedLayerGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (Pro && Object.hasOwn(dotNetObject, "collectionId")) {
        try {
    ...
    if (Pro && Object.hasOwn(dotNetObject, "historicMoment")) {
        try {
            // @ts-ignore GeoBlazor Pro only
    ...
    if (Pro && Object.hasOwn(dotNetObject, "drawOrderField")) {
        try {
            // @ts-ignore GeoBlazor Pro only
    ...
    if (Pro && Object.hasOwn(dotNetObject, "sourceJSON")) {
        try {
            // @ts-ignore GeoBlazor Pro only
    ...
    if (Pro && Object.hasOwn(dotNetObject, "allLayers")) {
        try {
            // @ts-ignore GeoBlazor Pro only
    ...
    if (Pro && Object.hasOwn(dotNetObject, "layers")) {
        try {
            // @ts-ignore GeoBlazor Pro only
...
export async function buildDotNetISliceAnalysisExcludedLayerGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (Pro && Object.hasOwn(jsObject, "collectionId")) {
        try {
            // @ts-ignore GeoBlazor Pro only
    ...
    if (Pro && Object.hasOwn(jsObject, "historicMoment")) {
        try {
            // @ts-ignore GeoBlazor Pro only
    ...
    if (Pro && Object.hasOwn(jsObject, "drawOrderField")) {
        try {
            // @ts-ignore GeoBlazor Pro only
    ...
    if (Pro && Object.hasOwn(jsObject, "sourceJSON")) {
        try {
            // @ts-ignore GeoBlazor Pro only
    ...
    if (Pro && Object.hasOwn(jsObject, "allLayers")) {
        try {
            // @ts-ignore GeoBlazor Pro only
    ...
    if (Pro && Object.hasOwn(jsObject, "layers")) {
        try {
            // @ts-ignore GeoBlazor Pro only
