...
export async function buildDotNetBaseLayerView2DRenderRenderParametersGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.state)) {
        ...
        dotNetBaseLayerView2DRenderRenderParameters.state = await buildDotNetViewState(jsObject.state, layerId, viewId);
    }
    
    if (hasValue(jsObject.context)) {
        dotNetBaseLayerView2DRenderRenderParameters.context = removeCircularReferences(jsObject.context);
    }
