...
export async function buildDotNetGraphicsLayerElevationInfoGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        dotNetGraphicsLayerElevationInfo.id = await dotNetRef.invokeMethodAsync('GetId');
    }
    if (hasValue(dotNetGraphicsLayerElevationInfo.id)) {
        jsObjectRefs[dotNetGraphicsLayerElevationInfo.id] ??= jsObject;
        arcGisObjectRefs[dotNetGraphicsLayerElevationInfo.id] ??= jsObject;
    }
