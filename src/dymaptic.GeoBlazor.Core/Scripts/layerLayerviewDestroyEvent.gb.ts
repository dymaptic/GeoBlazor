...
export async function buildJsLayerLayerviewDestroyEventGenerated(dotNetObject: any): Promise<any> {
    ...
    if (hasValue(dotNetObject.view)) {
        jsLayerLayerviewDestroyEvent.view = dotNetObject.view;
    }
...
export async function buildDotNetLayerLayerviewDestroyEventGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.view)) {
        dotNetLayerLayerviewDestroyEvent.view = jsObject.view;
    }
