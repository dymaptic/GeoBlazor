...
export async function buildDotNetAuthoringInfoField2ClassBreakInfos(jsObject: any): Promise<any> {
    let { buildDotNetAuthoringInfoField2ClassBreakInfosGenerated } = await import('./authoringInfoField2ClassBreakInfos.gb');
    return await buildDotNetAuthoringInfoField2ClassBreakInfosGenerated(jsObject);
}
