...
export default class ImageryTileLayerGenerated extends BaseComponent {
    ...
    async updateComponent(dotNetObject: any): Promise<void> {
        ...
        if (hasValue(dotNetObject.source)) {
            ...
            this.layer.source = await buildJsPixelData(dotNetObject.source, this.layerId, this.viewId) as any;
        }
    ...
    async saveAs(portalItem: any,
        ...
        if (!Pro) {
            ...
            try {
                ...
                jsOptions = await buildJsImageryTileLayerSaveAsOptions(options, this.layerId, this.viewId) as any;
            } catch (e) {
                console.error(`Pro functionality not available in GeoBlazor Core. ${e}`);
                jsOptions = null;
            }
    ...
    async getSource(): Promise<any> {
        ...
        let { buildDotNetPixelData } = await import('./pixelData');
        return await buildDotNetPixelData(this.layer.source, this.layerId, this.viewId);
    }
    
    async setSource(value: any): Promise<void> {
        let { buildJsPixelData } = await import('./pixelData');
        this.layer.source = await  buildJsPixelData(value, this.layerId, this.viewId);
    }
...
export async function buildJsImageryTileLayerGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.source)) {
        let { buildJsPixelData } = await import('./pixelData');
        properties.source = await buildJsPixelData(dotNetObject.source, layerId, viewId) as any;
    }
    if (hasValue(dotNetObject.tileInfo)) {
        let { buildJsTileInfo } = await import('./tileInfo');
...
export async function buildDotNetImageryTileLayerGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.source)) {
        let { buildDotNetPixelData } = await import('./pixelData');
        dotNetImageryTileLayer.source = await buildDotNetPixelData(jsObject.source, layerId, viewId);
    }
