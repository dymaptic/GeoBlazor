...
export async function buildJsLayerLayerviewCreateEventGenerated(dotNetObject: any): Promise<any> {
    ...
    if (hasValue(dotNetObject.view)) {
        jsLayerLayerviewCreateEvent.view = dotNetObject.view;
    }
...
export async function buildDotNetLayerLayerviewCreateEventGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.view)) {
        dotNetLayerLayerviewCreateEvent.view = jsObject.view;
    }
