...
export async function buildDotNetAreaMeasurementAnalysisResultGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsAreaMeasurementAnalysisResult } = await import('./areaMeasurementAnalysisResult');
        jsComponentRef = await buildJsAreaMeasurementAnalysisResult(jsObject, layerId, viewId);
    }
    ...
    if (hasValue(jsObject.area)) {
        ...
        dotNetAreaMeasurementAnalysisResult.area = await buildDotNetArea(jsObject.area, layerId, viewId);
    }
