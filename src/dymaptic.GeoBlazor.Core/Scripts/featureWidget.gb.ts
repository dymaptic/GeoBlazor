...
export default class FeatureWidgetGenerated implements IPropertyWrapper {
    ...
    async setSpatialReference(value: any): Promise<void> {
        ...
        this.widget.spatialReference = await  buildJsSpatialReference(value, this.layerId, this.viewId);
    }
    ...
    async getVisibleElements(): Promise<any> {
        ...
        return await buildDotNetFeatureVisibleElements(this.widget.visibleElements, this.layerId, this.viewId);
    }
    async setVisibleElements(value: any): Promise<void> {
        let { buildJsFeatureVisibleElements } = await import('./featureVisibleElements');
        this.widget.visibleElements = await  buildJsFeatureVisibleElements(value, this.layerId, this.viewId);
    }
...
export async function buildJsFeatureWidgetGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.spatialReference)) {
        let { buildJsSpatialReference } = await import('./spatialReference');
        jsFeature.spatialReference = await buildJsSpatialReference(dotNetObject.spatialReference, layerId, viewId) as any;
    }
    ...
    if (hasValue(dotNetObject.visibleElements)) {
        let { buildJsFeatureVisibleElements } = await import('./featureVisibleElements');
        jsFeature.visibleElements = await buildJsFeatureVisibleElements(dotNetObject.visibleElements, layerId, viewId) as any;
    }
...
export async function buildDotNetFeatureWidgetGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let dotNetFeatureWidget: any = {
        ...
        if (hasValue(jsObject.visibleElements)) {
            let { buildDotNetFeatureVisibleElements } = await import('./featureVisibleElements');
            dotNetFeatureWidget.visibleElements = await buildDotNetFeatureVisibleElements(jsObject.visibleElements, layerId, viewId);
        }
