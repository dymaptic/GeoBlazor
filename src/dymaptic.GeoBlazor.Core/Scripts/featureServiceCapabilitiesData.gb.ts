...
export async function buildJsFeatureServiceCapabilitiesDataGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let dnInstantiatedObject = await buildDotNetFeatureServiceCapabilitiesData(jsFeatureServiceCapabilitiesData);
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null
                    ...
                    if (seenObjects.has(value)) {
                        console.warn(`Circular reference in serializing type FeatureServiceCapabilitiesData detected at path: ${key}, value: ${value.declaredClass}`);
                        return undefined;
                    }
...
export async function buildDotNetFeatureServiceCapabilitiesDataGenerated(jsObject: any): Promise<any> {
