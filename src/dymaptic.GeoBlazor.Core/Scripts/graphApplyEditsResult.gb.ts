...
export async function buildDotNetGraphApplyEditsResultGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.editResults)) {
        ...
        dotNetGraphApplyEditsResult.editResults = await Promise.all(jsObject.editResults.map(async i => await buildDotNetEditResultsObject(i)));
    }
