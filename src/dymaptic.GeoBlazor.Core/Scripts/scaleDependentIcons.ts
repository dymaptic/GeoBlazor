...
export async function buildDotNetScaleDependentIcons(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    let {buildDotNetScaleDependentIconsGenerated} = await import('./scaleDependentIcons.gb');
    return await buildDotNetScaleDependentIconsGenerated(jsObject, layerId, viewId);
}
