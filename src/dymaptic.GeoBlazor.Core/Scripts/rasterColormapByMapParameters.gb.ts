...
export async function buildDotNetRasterColormapByMapParametersGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsRasterColormapByMapParameters } = await import('./rasterColormapByMapParameters');
        jsComponentRef = await buildJsRasterColormapByMapParameters(jsObject, layerId, viewId);
    }
