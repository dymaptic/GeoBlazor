...
export async function buildDotNetVersionManagementServiceVersionIdentifier(jsObject: any): Promise<any> {
    ...
    return await buildDotNetVersionManagementServiceVersionIdentifierGenerated(jsObject);
}
