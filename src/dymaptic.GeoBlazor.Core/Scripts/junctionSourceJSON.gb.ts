...
export async function buildDotNetJunctionSourceJSONGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.assetGroups)) {
        ...
        dotNetJunctionSourceJSON.assetGroups = await Promise.all(jsObject.assetGroups.map(async i => await buildDotNetAssetGroupJSON(i)));
    }
