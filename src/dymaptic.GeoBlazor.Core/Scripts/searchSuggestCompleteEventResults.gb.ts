...
export async function buildJsSearchSuggestCompleteEventResultsGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.results) && dotNetObject.results.length > 0) {
        ...
        jsSearchSuggestCompleteEventResults.results = dotNetObject.results.map(i => buildJsSuggestResult(i, viewId)) as any;
    }
...
export async function buildDotNetSearchSuggestCompleteEventResultsGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.results)) {
        ...
        dotNetSearchSuggestCompleteEventResults.results = jsObject.results.map(i => buildDotNetSuggestResult(i, viewId));
    }
