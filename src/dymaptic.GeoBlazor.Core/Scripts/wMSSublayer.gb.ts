...
export async function buildJsWMSSublayerGenerated(dotNetObject: any, viewId: string | null): Promise<any> {
...
export async function buildDotNetWMSSublayerGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.fullExtent)) {
        ...
        dotNetWMSSublayer.fullExtent = buildDotNetExtent(jsObject.fullExtent, viewId);
    }
    ...
    if (hasValue(geoBlazorId)) {
        ...
        dotNetWMSSublayer.id = await dotNetRef.invokeMethodAsync('GetId');
    }
