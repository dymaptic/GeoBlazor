...
export async function buildJsSceneViewEnvironmentAtmosphereGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    try {
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null
                    ...
                    if (seenObjects.has(value)) {
                        console.debug(`Circular reference in serializing type SceneViewEnvironmentAtmosphere detected at path: ${key}, value: ${value.declaredClass}`);
                        return undefined;
                    }
        ...
        console.error('Error invoking OnJsComponentCreated for SceneViewEnvironmentAtmosphere', e);
    }
