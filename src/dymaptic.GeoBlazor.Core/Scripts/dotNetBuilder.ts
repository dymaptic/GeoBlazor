...
function buildDotNetPieChartRenderer(jsRenderer: PieChartRenderer): any {
    ...
    dnRenderer.authoringInfo = {
        classificationMethod: jsRenderer.authoringInfo.classificationMethod,
        colorRamp: {
            type: jsRenderer.authoringInfo.colorRamp.type
        },
        fadeRatio: jsRenderer.authoringInfo.fadeRatio,
        field1: jsRenderer.authoringInfo.field1,
        field2: jsRenderer.authoringInfo.field2,
        flowTheme: jsRenderer.authoringInfo.flowTheme,
        focus: jsRenderer.authoringInfo.focus,
        isAutoGenerated: jsRenderer.authoringInfo.isAutoGenerated,
        lengthUnit: jsRenderer.authoringInfo.lengthUnit,
        maxSliderValue: jsRenderer.authoringInfo.maxSliderValue,
        minSliderValue: jsRenderer.authoringInfo.minSliderValue,
        numClasses: jsRenderer.authoringInfo.numClasses,
        standardDeviationInterval: jsRenderer.authoringInfo.standardDeviationInterval,
        statistics: jsRenderer.authoringInfo.statistics,
        type: jsRenderer.authoringInfo.type
    }
