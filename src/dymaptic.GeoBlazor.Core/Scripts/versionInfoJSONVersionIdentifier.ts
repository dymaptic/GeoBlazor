...
export async function buildDotNetVersionInfoJSONVersionIdentifier(jsObject: any): Promise<any> {
    let { buildDotNetVersionInfoJSONVersionIdentifierGenerated } = await import('./versionInfoJSONVersionIdentifier.gb');
    return await buildDotNetVersionInfoJSONVersionIdentifierGenerated(jsObject);
}
