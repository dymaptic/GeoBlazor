...
export async function buildDotNetWFSLayerGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.effect)) {
        dotNetWFSLayer.effect = removeCircularReferences(jsObject.effect);
    }
    
    if (hasValue(jsObject.featureReduction)) {
        dotNetWFSLayer.featureReduction = removeCircularReferences(jsObject.featureReduction);
    }
    
    if (hasValue(jsObject.fieldsIndex)) {
        dotNetWFSLayer.fieldsIndex = removeCircularReferences(jsObject.fieldsIndex);
    }
    ...
    if (hasValue(jsObject.renderer)) {
        dotNetWFSLayer.renderer = jsObject.renderer;
    }
    ...
    if (hasValue(jsObject.spatialReference)) {
        dotNetWFSLayer.spatialReference = removeCircularReferences(jsObject.spatialReference);
    }
