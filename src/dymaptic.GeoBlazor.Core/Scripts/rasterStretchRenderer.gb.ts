...
export async function buildDotNetRasterStretchRendererGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.colorRamp)) {
        ...
        dotNetRasterStretchRenderer.colorRamp = buildDotNetColorRamp(jsObject.colorRamp, viewId);
    }
