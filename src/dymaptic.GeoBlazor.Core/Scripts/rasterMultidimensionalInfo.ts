...
export async function buildDotNetRasterMultidimensionalInfo(jsObject: any): Promise<any> {
    let { buildDotNetRasterMultidimensionalInfoGenerated } = await import('./rasterMultidimensionalInfo.gb');
    return await buildDotNetRasterMultidimensionalInfoGenerated(jsObject);
}
