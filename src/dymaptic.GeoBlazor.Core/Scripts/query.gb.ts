...
export async function buildDotNetQueryGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.outSpatialReference)) {
        dotNetQuery.outSpatialReference = removeCircularReferences(jsObject.outSpatialReference);
    }
    
    if (hasValue(jsObject.outStatistics)) {
        dotNetQuery.outStatistics = removeCircularReferences(jsObject.outStatistics);
    }
    ...
    if (hasValue(jsObject.quantizationParameters)) {
        dotNetQuery.quantizationParameters = removeCircularReferences(jsObject.quantizationParameters);
    }
    
    if (hasValue(jsObject.rangeValues)) {
        dotNetQuery.rangeValues = removeCircularReferences(jsObject.rangeValues);
    }
