...
export default class WMSLayerGenerated extends BaseComponent {
    ...
    async findSublayerByName(name: any): Promise<any> {
        let paramList: any[] = [];
        paramList.push(name);
        let result = this.layer.findSublayerByName(...paramList as [any]) as any;
        let { buildDotNetWMSSublayer } = await import('./wMSSublayer');
        return await buildDotNetWMSSublayer(result, this.viewId);
    }
    ...
    getFeatureInfoUrl(): any {
        ...
        return this.layer.featureInfoUrl;
    }
    
    setFeatureInfoUrl(value: any): void {
        this.layer.featureInfoUrl = value;
    }
    ...
    getImageFormat(): any {
        ...
        return this.layer.imageFormat;
    }
    
    setImageFormat(value: any): void {
        this.layer.imageFormat = value;
    }
