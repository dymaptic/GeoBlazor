...
export default class WMSLayerGenerated extends BaseComponent {
    ...
    getDescription(): any {
        ...
        return removeCircularReferences(this.layer.description);
    }
    ...
    getFeatureInfoUrl(): any {
        ...
        return removeCircularReferences(this.layer.featureInfoUrl);
    }
    ...
    getImageFormat(): any {
        ...
        return removeCircularReferences(this.layer.imageFormat);
    }
...
export async function buildDotNetWMSLayerGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.customLayerParameters)) {
        dotNetWMSLayer.customLayerParameters = removeCircularReferences(jsObject.customLayerParameters);
    }
