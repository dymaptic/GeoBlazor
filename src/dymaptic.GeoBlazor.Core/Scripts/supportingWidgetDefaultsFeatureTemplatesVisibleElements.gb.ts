...
export async function buildJsSupportingWidgetDefaultsFeatureTemplatesVisibleElementsGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let dnInstantiatedObject = await buildDotNetSupportingWidgetDefaultsFeatureTemplatesVisibleElements(jsSupportingWidgetDefaultsFeatureTemplatesVisibleElements);
...
export async function buildDotNetSupportingWidgetDefaultsFeatureTemplatesVisibleElementsGenerated(jsObject: any): Promise<any> {
