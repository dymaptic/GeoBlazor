...
export async function buildDotNetRasterFunctionUtilsRemapParametersGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsRasterFunctionUtilsRemapParameters } = await import('./rasterFunctionUtilsRemapParameters');
        jsComponentRef = await buildJsRasterFunctionUtilsRemapParameters(jsObject, layerId, viewId);
    }
