...
export async function buildDotNetDOMContainerGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsDOMContainer } = await import('./dOMContainer');
        jsComponentRef = await buildJsDOMContainer(jsObject, layerId, viewId);
    }
    ...
    if (hasValue(jsObject.ui)) {
        ...
        dotNetDOMContainer.ui = await buildDotNetDefaultUI(jsObject.ui, layerId, viewId);
    }
