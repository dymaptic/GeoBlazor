...
export async function buildJsKMLLayerViewMapImageGenerated(dotNetObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.extent)) {
        ...
        jsKMLLayerViewMapImage.extent = buildJsExtent(dotNetObject.extent, viewId) as any;
    }
...
export async function buildDotNetKMLLayerViewMapImageGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.extent)) {
        ...
        dotNetKMLLayerViewMapImage.extent = buildDotNetExtent(jsObject.extent, viewId);
    }
