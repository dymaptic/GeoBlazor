...
export async function buildDotNetPrintSubmitEventGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.results)) {
        ...
        dotNetPrintSubmitEvent.results = await buildDotNetPrintSubmitEventResults(jsObject.results);
    }
