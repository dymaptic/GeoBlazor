...
export async function buildDotNetViewLayerviewCreateErrorEventGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsViewLayerviewCreateErrorEvent } = await import('./viewLayerviewCreateErrorEvent');
        jsComponentRef = await buildJsViewLayerviewCreateErrorEvent(jsObject, layerId, viewId);
    }
