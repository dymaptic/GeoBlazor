...
export default class PopupWidgetGenerated extends BaseComponent {
    ...
    async triggerAction(actionIndex: any): Promise<void> {
        ...
        this.widget.triggerAction(...paramList as [any]);
    }
    ...
    async getContent(): Promise<any> {
        ...
        return await buildDotNetWidget(this.widget.content);
    }
    ...
    getPromises(): any {
        ...
        return this.widget.promises;
    }
    
    setPromises(value: any): void {
        this.widget.promises = value;
    }
...
export async function buildDotNetPopupWidgetGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.content)) {
        let { buildDotNetWidget } = await import('./widget');
        dotNetPopupWidget.content = await buildDotNetWidget(jsObject.content);
    }
