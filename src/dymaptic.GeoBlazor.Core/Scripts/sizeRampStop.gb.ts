...
import { arcGisObjectRefs, jsObjectRefs, dotNetRefs, hasValue, lookupGeoBlazorId, removeCircularReferences, applyCaptureIdToElement } from './geoBlazorCore';
...
export async function buildJsSizeRampStopGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.symbol)) {
        ...
        jsSizeRampStop.symbol = buildJsSymbol(dotNetObject.symbol, layerId, viewId) as any;
    }
...
export async function buildDotNetSizeRampStopGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.preview)) {
        let referenceCaptureId = applyCaptureIdToElement(jsObject.preview);
        dotNetSizeRampStop.preview = {
    ...
    if (hasValue(jsObject.value)) {
        dotNetSizeRampStop.value = removeCircularReferences(jsObject.value);
    }
