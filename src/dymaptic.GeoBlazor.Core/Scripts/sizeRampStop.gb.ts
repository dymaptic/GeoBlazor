...
export async function buildJsSizeRampStopGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    try {
        ...
        let dnInstantiatedObject = await buildDotNetSizeRampStop(jsSizeRampStop, layerId, viewId);
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null
                    ...
                    if (seenObjects.has(value)) {
                        console.debug(`Circular reference in serializing type SizeRampStop detected at path: ${key}, value: ${value.declaredClass}`);
                        return undefined;
                    }
