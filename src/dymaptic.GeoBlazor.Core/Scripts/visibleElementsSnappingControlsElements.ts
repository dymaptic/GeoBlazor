...
export async function buildDotNetVisibleElementsSnappingControlsElements(jsObject: any): Promise<any> {
    let { buildDotNetVisibleElementsSnappingControlsElementsGenerated } = await import('./visibleElementsSnappingControlsElements.gb');
    return await buildDotNetVisibleElementsSnappingControlsElementsGenerated(jsObject);
}
