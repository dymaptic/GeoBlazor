...
export async function buildDotNetFindImagesResult(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    let {buildDotNetFindImagesResultGenerated} = await import('./findImagesResult.gb');
    return await buildDotNetFindImagesResultGenerated(jsObject, layerId, viewId);
}
