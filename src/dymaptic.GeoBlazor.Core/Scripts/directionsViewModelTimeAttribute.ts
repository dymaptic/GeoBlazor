...
export async function buildDotNetDirectionsViewModelTimeAttribute(jsObject: any): Promise<any> {
    let { buildDotNetDirectionsViewModelTimeAttributeGenerated } = await import('./directionsViewModelTimeAttribute.gb');
    return await buildDotNetDirectionsViewModelTimeAttributeGenerated(jsObject);
}
