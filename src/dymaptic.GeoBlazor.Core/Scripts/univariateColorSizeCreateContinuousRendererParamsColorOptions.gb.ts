...
export async function buildJsUnivariateColorSizeCreateContinuousRendererParamsColorOptionsGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
