...
export async function buildDotNetSliderWidgetGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.effectiveSegmentElements)) {
        dotNetSliderWidget.effectiveSegmentElements = removeCircularReferences(jsObject.effectiveSegmentElements);
    }
    ...
    if (hasValue(jsObject.labelElements)) {
        dotNetSliderWidget.labelElements = removeCircularReferences(jsObject.labelElements);
    }
    ...
    if (hasValue(jsObject.maxLabelElement)) {
        dotNetSliderWidget.maxLabelElement = removeCircularReferences(jsObject.maxLabelElement);
    }
    ...
    if (hasValue(jsObject.minLabelElement)) {
        dotNetSliderWidget.minLabelElement = removeCircularReferences(jsObject.minLabelElement);
    }
    ...
    if (hasValue(jsObject.segmentElements)) {
        dotNetSliderWidget.segmentElements = removeCircularReferences(jsObject.segmentElements);
    }
    ...
    if (hasValue(jsObject.thumbElements)) {
        dotNetSliderWidget.thumbElements = removeCircularReferences(jsObject.thumbElements);
    }
    ...
    if (hasValue(jsObject.trackElement)) {
        dotNetSliderWidget.trackElement = removeCircularReferences(jsObject.trackElement);
    }
