...
import { arcGisObjectRefs, jsObjectRefs, dotNetRefs, hasValue, lookupGeoBlazorId, removeCircularReferences, buildJsStreamReference, applyCaptureIdToElement } from './geoBlazorCore';
...
export async function buildDotNetSliderWidgetGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.maxLabelElement)) {
        let referenceCaptureId = applyCaptureIdToElement(jsObject.maxLabelElement);
        dotNetSliderWidget.maxLabelElement = {
            'gb_element_ref_id': referenceCaptureId
        };
    }
    ...
    if (hasValue(jsObject.minLabelElement)) {
        let referenceCaptureId = applyCaptureIdToElement(jsObject.minLabelElement);
        dotNetSliderWidget.minLabelElement = {
            'gb_element_ref_id': referenceCaptureId
        };
    }
    ...
    if (hasValue(jsObject.trackElement)) {
        let referenceCaptureId = applyCaptureIdToElement(jsObject.trackElement);
        dotNetSliderWidget.trackElement = {
            'gb_element_ref_id': referenceCaptureId
        };
    }
