...
import { arcGisObjectRefs, jsObjectRefs, hasValue, removeCircularReferences, buildJsStreamReference } from './geoBlazorCore';
...
export default class LocateWidgetGenerated extends BaseComponent {
    ...
    getGeolocationOptions(): any {
        ...
        return removeCircularReferences(this.widget.geolocationOptions);
    }
