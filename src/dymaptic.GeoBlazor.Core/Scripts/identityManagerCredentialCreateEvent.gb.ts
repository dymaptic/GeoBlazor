...
export async function buildDotNetIdentityManagerCredentialCreateEventGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsIdentityManagerCredentialCreateEvent } = await import('./identityManagerCredentialCreateEvent');
        jsComponentRef = await buildJsIdentityManagerCredentialCreateEvent(jsObject, layerId, viewId);
    }
