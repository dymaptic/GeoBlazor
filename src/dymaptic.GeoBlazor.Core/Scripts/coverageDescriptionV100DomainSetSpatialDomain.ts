...
export async function buildDotNetCoverageDescriptionV100DomainSetSpatialDomain(jsObject: any, viewId: string | null): Promise<any> {
    ...
    return await buildDotNetCoverageDescriptionV100DomainSetSpatialDomainGenerated(jsObject, viewId);
}
