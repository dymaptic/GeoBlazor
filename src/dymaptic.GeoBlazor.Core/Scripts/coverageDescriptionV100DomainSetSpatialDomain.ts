...
export async function buildDotNetCoverageDescriptionV100DomainSetSpatialDomain(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    return await buildDotNetCoverageDescriptionV100DomainSetSpatialDomainGenerated(jsObject, layerId, viewId);
}
