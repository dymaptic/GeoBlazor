...
export async function buildDotNetSearchViewModelSuggestCompleteEventResults(jsObject: any, viewId: string | null): Promise<any> {
    ...
    return await buildDotNetSearchViewModelSuggestCompleteEventResultsGenerated(jsObject, viewId);
}
