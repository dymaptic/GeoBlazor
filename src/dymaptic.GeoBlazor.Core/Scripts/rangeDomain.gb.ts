...
export async function buildJsRangeDomainGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let { buildDotNetRangeDomain } = await import('./rangeDomain');
    let dnInstantiatedObject = await buildDotNetRangeDomain(jsRangeDomain);
    ...
    try {
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null
                    ...
                    if (seenObjects.has(value)) {
                        console.warn(`Circular reference in serializing type RangeDomain detected at path: ${key}, value: ${value.declaredClass}`);
                        return undefined;
                    }
        ...
        console.error('Error invoking OnJsComponentCreated for RangeDomain', e);
    }
...
export async function buildDotNetRangeDomainGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.type)) {
        dotNetRangeDomain.type = jsObject.type;
    }
