...
export async function buildDotNetBaseLayerView2DRenderRenderParameters(jsObject: any): Promise<any> {
    let { buildDotNetBaseLayerView2DRenderRenderParametersGenerated } = await import('./baseLayerView2DRenderRenderParameters.gb');
    return await buildDotNetBaseLayerView2DRenderRenderParametersGenerated(jsObject);
}
