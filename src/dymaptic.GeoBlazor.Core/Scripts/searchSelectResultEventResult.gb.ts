...
export async function buildJsSearchSelectResultEventResultGenerated(dotNetObject: any): Promise<any> {
    ...
    let dnInstantiatedObject = await buildDotNetSearchSelectResultEventResult(jsSearchSelectResultEventResult);
