...
import { buildDotNetWebTileLayer } from './webTileLayer';
    ...
    switch (jsObject.type) {
        case 'web-tile': 
            ...
            if (hasValue(jsObject.fullExtent)) {
                let { buildDotNetExtent } = await import('./extent');
                dotNetWebTileLayer.fullExtent = buildDotNetExtent(jsObject.fullExtent, viewId);
            }
            ...
            if (hasValue(jsObject.spatialReference)) {
                let { buildDotNetSpatialReference } = await import('./spatialReference');
                dotNetWebTileLayer.spatialReference = buildDotNetSpatialReference(jsObject.spatialReference, viewId);
            }
            ...
            if (hasValue(jsObject.visibilityTimeExtent)) {
                let { buildDotNetTimeExtent } = await import('./timeExtent');
                dotNetWebTileLayer.visibilityTimeExtent = buildDotNetTimeExtent(jsObject.visibilityTimeExtent, viewId);
            }
            ...
            if (hasValue(jsObject.blendMode)) {
                dotNetWebTileLayer.blendMode = removeCircularReferences(jsObject.blendMode);
            }
            ...
            if (hasValue(jsObject.listMode)) {
                dotNetWebTileLayer.listMode = removeCircularReferences(jsObject.listMode);
            }
            ...
            if (hasValue(jsObject.type)) {
                dotNetWebTileLayer.type = removeCircularReferences(jsObject.type);
            }
            ...
            if (hasValue(jsObject.visible)) {
                dotNetWebTileLayer.visible = jsObject.visible;
            }
    

            let geoBlazorId = lookupGeoBlazorId(jsObject);
            if (hasValue(geoBlazorId)) {
                dotNetWebTileLayer.id = geoBlazorId;
            } else if (hasValue(viewId)) {
                let dotNetRef = dotNetRefs[viewId!];
                dotNetWebTileLayer.id = await dotNetRef.invokeMethodAsync('GetId');
            }
