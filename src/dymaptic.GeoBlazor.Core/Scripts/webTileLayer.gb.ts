...
import { arcGisObjectRefs, jsObjectRefs, dotNetRefs, hasValue, lookupGeoBlazorId, sanitize, removeCircularReferences, buildJsStreamReference } from './geoBlazorCore';
import BaseComponent from "./baseComponent";

export default class WebTileLayerGenerated extends BaseComponent {
    ...
    getUrlTemplate(): any {
        ...
        return removeCircularReferences(this.layer.urlTemplate);
    }
            ...
            if (hasValue(geoBlazorId)) {
                ...
                if (hasValue(dotNetRef)) {
                    try {
                        ...
                        console.error('Error invoking GetId for WebTileLayer', e);
                    }
                }
            }
