...
export async function buildJsFeatureReductionSelectionGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let { buildDotNetFeatureReductionSelection } = await import('./featureReductionSelection');
    let dnInstantiatedObject = await buildDotNetFeatureReductionSelection(jsFeatureReductionSelection);
    ...
    try {
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null
                    ...
                    if (seenObjects.has(value)) {
                        console.debug(`Circular reference in serializing type FeatureReductionSelection detected at path: ${key}, value: ${value.declaredClass}`);
                        return undefined;
                    }
        ...
        console.error('Error invoking OnJsComponentCreated for FeatureReductionSelection', e);
    }
