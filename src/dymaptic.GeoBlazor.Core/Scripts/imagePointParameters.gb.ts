...
export async function buildDotNetImagePointParametersGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        jsComponentRef = await buildJsImagePointParameters(jsObject, layerId, viewId);
    }
    ...
    if (hasValue(jsObject.mosaicRule)) {
        ...
        dotNetImagePointParameters.mosaicRule = await buildDotNetMosaicRule(jsObject.mosaicRule, layerId, viewId);
    }
