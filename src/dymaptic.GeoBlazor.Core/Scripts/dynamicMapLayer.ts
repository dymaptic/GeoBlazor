...
export async function buildDotNetDynamicMapLayer(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    let { buildDotNetDynamicMapLayerGenerated } = await import('./dynamicMapLayer.gb');
    return await buildDotNetDynamicMapLayerGenerated(jsObject, layerId, viewId);
}
