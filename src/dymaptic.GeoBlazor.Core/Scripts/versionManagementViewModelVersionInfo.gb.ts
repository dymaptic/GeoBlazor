...
export async function buildDotNetVersionManagementViewModelVersionInfoGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsVersionManagementViewModelVersionInfo } = await import('./versionManagementViewModelVersionInfo');
        jsComponentRef = await buildJsVersionManagementViewModelVersionInfo(jsObject, layerId, viewId);
    }
