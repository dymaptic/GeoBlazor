...
export async function buildDotNetVersionManagementViewModelVersionInfoGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.versionIdentifier)) {
        ...
        dotNetVersionManagementViewModelVersionInfo.versionIdentifier = await buildDotNetVersionManagementServiceVersionIdentifier(jsObject.versionIdentifier);
    }
    if (hasValue(jsObject.access)) {
        dotNetVersionManagementViewModelVersionInfo.access = jsObject.access;
    }
