...
export async function buildDotNetVisibleElementsSelectionTools(jsObject: any): Promise<any> {
    let { buildDotNetVisibleElementsSelectionToolsGenerated } = await import('./visibleElementsSelectionTools.gb');
    return await buildDotNetVisibleElementsSelectionToolsGenerated(jsObject);
}
