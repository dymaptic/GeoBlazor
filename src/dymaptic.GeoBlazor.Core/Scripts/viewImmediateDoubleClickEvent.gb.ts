...
export async function buildDotNetViewImmediateDoubleClickEventGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsViewImmediateDoubleClickEvent } = await import('./viewImmediateDoubleClickEvent');
        jsComponentRef = await buildJsViewImmediateDoubleClickEvent(jsObject, layerId, viewId);
    }
