...
export async function buildDotNetPredominantCategoriesResultGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.predominantCategoryInfos)) {
        ...
        dotNetPredominantCategoriesResult.predominantCategoryInfos = await Promise.all(jsObject.predominantCategoryInfos.map(async i => await buildDotNetPredominantCategoriesResultPredominantCategoryInfos(i)));
    }
