...
export async function buildDotNetCoverageDescriptionV201Generated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.coverageFunction)) {
        dotNetCoverageDescriptionV201.coverageFunction = removeCircularReferences(jsObject.coverageFunction);
    }
    ...
    if (hasValue(jsObject.serviceParameters)) {
        dotNetCoverageDescriptionV201.serviceParameters = removeCircularReferences(jsObject.serviceParameters);
    }
