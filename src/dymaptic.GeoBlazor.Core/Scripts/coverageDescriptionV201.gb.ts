...
export async function buildJsCoverageDescriptionV201Generated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    let { buildDotNetCoverageDescriptionV201 } = await import('./coverageDescriptionV201');
            ...
            jsObjectRef, JSON.stringify(dnInstantiatedObject, function (key, value) {
                ...
                if (typeof value === 'object' && value !== null) {
                    if (seenObjects.has(value)) {
                        console.warn(`Circular reference in serializing type CoverageDescriptionV201 detected at path: ${key}, value: ${value.__proto__?.declaredClass}`);
                        return undefined;
                    }
