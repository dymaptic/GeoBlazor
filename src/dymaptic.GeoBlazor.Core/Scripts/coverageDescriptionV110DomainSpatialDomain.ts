...
export async function buildDotNetCoverageDescriptionV110DomainSpatialDomain(jsObject: any): Promise<any> {
    ...
    return await buildDotNetCoverageDescriptionV110DomainSpatialDomainGenerated(jsObject);
}
