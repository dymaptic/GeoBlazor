...
export async function buildDotNetCoverageDescriptionV110DomainSpatialDomain(jsObject: any, viewId: string | null): Promise<any> {
    ...
    return await buildDotNetCoverageDescriptionV110DomainSpatialDomainGenerated(jsObject, viewId);
}
