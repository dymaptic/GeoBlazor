...
export async function buildJsLayerViewDestroyEventGenerated(dotNetObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(dotNetObject.layerView)) {
        ...
        jsFeatureLayerLayerviewDestroyEvent.layerView = buildJsLayerView(dotNetObject.layerView) as any;
    }
...
export async function buildDotNetLayerViewDestroyEventGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.layerView)) {
        ...
        dotNetLayerViewDestroyEvent.layerView = buildDotNetLayerView(jsObject.layerView);
    }
