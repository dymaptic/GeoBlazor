...
export async function buildDotNetFoggyWeatherGenerated(jsObject: any, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        if (hasValue(dotNetRef)) {
            try {
                ...
                console.error('Error invoking GetId for FoggyWeather', e);
            }
        }
    }
