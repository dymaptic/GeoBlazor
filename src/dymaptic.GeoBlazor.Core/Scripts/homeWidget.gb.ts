...
export default class HomeWidgetGenerated extends BaseComponent {
    public widget: Home;
    ...
    getUiStrings(): any {
        ...
        return removeCircularReferences(this.widget.uiStrings);
    }
...
export async function buildDotNetHomeWidgetGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(jsObject.uiStrings)) {
        dotNetHomeWidget.uiStrings = removeCircularReferences(jsObject.uiStrings);
    }
