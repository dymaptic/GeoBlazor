...
export async function buildDotNetMeasureLengthFromImageResultGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsMeasureLengthFromImageResult } = await import('./measureLengthFromImageResult');
        jsComponentRef = await buildJsMeasureLengthFromImageResult(jsObject, layerId, viewId);
    }
