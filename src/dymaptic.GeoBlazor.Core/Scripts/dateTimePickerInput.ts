...
export async function buildDotNetDateTimePickerInput(jsObject: any, viewId: string | null): Promise<any> {
    let { buildDotNetDateTimePickerInputGenerated } = await import('./dateTimePickerInput.gb');
    return await buildDotNetDateTimePickerInputGenerated(jsObject, viewId);
}
