...
export async function buildDotNetKnowledgeGraphSublayerCapabilitiesGenerated(jsObject: any, layerId: string | null, viewId: string | null): Promise<any> {
    ...
    if (hasValue(geoBlazorId)) {
        ...
        let { buildJsKnowledgeGraphSublayerCapabilities } = await import('./knowledgeGraphSublayerCapabilities');
        jsComponentRef = await buildJsKnowledgeGraphSublayerCapabilities(jsObject, layerId, viewId);
    }
