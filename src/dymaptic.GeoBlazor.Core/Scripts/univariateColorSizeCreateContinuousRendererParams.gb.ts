import {
    buildDotNetUnivariateColorSizeCreateContinuousRendererParams
} from './univariateColorSizeCreateContinuousRendererParams';
import {arcGisObjectRefs, hasValue, jsObjectRefs} from './arcGisJsInterop';

export async function buildJsUnivariateColorSizeCreateContinuousRendererParamsGenerated(dotNetObject: any): Promise<any> {
