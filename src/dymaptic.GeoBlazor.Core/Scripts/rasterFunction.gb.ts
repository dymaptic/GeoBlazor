...
export async function buildDotNetRasterFunctionGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.functionArguments)) {
        dotNetRasterFunction.functionArguments = removeCircularReferences(jsObject.functionArguments);
    }
    ...
    if (hasValue(jsObject.rasterFunctionDefinition)) {
        dotNetRasterFunction.rasterFunctionDefinition = removeCircularReferences(jsObject.rasterFunctionDefinition);
    }
