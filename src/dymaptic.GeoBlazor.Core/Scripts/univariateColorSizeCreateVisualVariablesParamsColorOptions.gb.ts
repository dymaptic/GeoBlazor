import {
    buildDotNetUnivariateColorSizeCreateVisualVariablesParamsColorOptions
} from './univariateColorSizeCreateVisualVariablesParamsColorOptions';
import {arcGisObjectRefs, hasValue, jsObjectRefs} from './arcGisJsInterop';

export async function buildJsUnivariateColorSizeCreateVisualVariablesParamsColorOptionsGenerated(dotNetObject: any): Promise<any> {
