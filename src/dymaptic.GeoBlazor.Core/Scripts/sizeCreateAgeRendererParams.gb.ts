...
export async function buildJsSizeCreateAgeRendererParamsGenerated(dotNetObject: any): Promise<any> {
    ...
    if (hasValue(dotNetObject.theme)) {
        ...
        jssizeCreateAgeRendererParams.theme = sanitizedTheme;
    }
...
export async function buildDotNetSizeCreateAgeRendererParamsGenerated(jsObject: any): Promise<any> {
    ...
    if (hasValue(jsObject.theme)) {
        dotNetSizeCreateAgeRendererParams.theme = jsObject.theme;
    }
